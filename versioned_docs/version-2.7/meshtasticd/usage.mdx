...
- [CLI Installation](/docs/2.7/software/python/cli/installation/)
- [CLI Usage](/docs/2.7/software/python/cli/usage/)
...
First, [Pull the image](/docs/2.7/meshtasticd/installation/docker)
