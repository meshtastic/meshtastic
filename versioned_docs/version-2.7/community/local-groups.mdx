...
To be listed here, your group must be in compliance with our [Trademark Guidelines](https://meshtastic.org/docs/2.7/legal/licensing-and-trademark/#social-media). In short:
- Groups may use the Meshtastic logo if it is in a secondary position to the group's primary branding. If in doubt, the [M-Powered Logo](/docs/2.7/legal/licensing-and-trademark/#community-project-logos-m-powered--m-pwrd) or a custom design should be used instead.
