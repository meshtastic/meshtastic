...
- Make sure that your cable is not only for charging but also for [data transfer](/docs/2.7/getting-started#verify-data-cable).
- It's possible that you need to [reinstall the USB serial driver](/docs/2.7/getting-started/serial-drivers).
