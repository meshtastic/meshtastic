...
[ROM bootloader can be entered](/docs/2.7/getting-started/flashing-firmware/stm32/entering-bootloader-mode)
...
[flash STM32WL over UART](/docs/2.7/getting-started/flashing-firmware/stm32/flashing-over-uart)
without an SWD programmer, once the board is in the ROM bootloader.

### Flashing over SWD

An SWD programmer such as an ST-LINK
[writes firmware straight to flash over the SWD pins](/docs/2.7/getting-started/flashing-firmware/stm32/flashing-over-swd),
...
[Wio-E5 page](/docs/2.7/hardware/devices/community-supported/seeed-studio/wio-series/seeed-wio-e5?e5=wio-e5-dev).
...
[readout protection is removed](/docs/2.7/getting-started/flashing-firmware/stm32/removing-readout-protection).
