...
7. Find the file included in the downloaded firmware matching your softdevice major version number (7.x.x or 6.x.x). Either use `Meshtastic_nRF52_factory_erase_v3_S140_7.3.0.uf2` or `Meshtastic_nRF52_factory_erase_v3_S140_6.1.0.uf2` and copy it onto the new drive. The device should reboot.
8. With the [Meshtastic CLI](/docs/2.7/software/python/cli/) installed, open your Terminal/Console and enter the command: `meshtastic --noproto`.
