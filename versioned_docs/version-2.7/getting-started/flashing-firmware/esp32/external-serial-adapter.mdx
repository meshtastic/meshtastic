...
:::info
This information will likely only be helpful if you've already attempted to go through the prerequisites and processes outlined in [manually flashing](/docs/2.7/getting-started/flashing-firmware/esp32/cli-script)
:::
...
![USB-to-serial adapter plugged into a computer](https://user-images.githubusercontent.com/9000580/168445869-f73667f5-0169-46fd-ae13-15c3abad31aa.png)
...
5. Bridge GPIO 0 to GND on the device with a jumper. (This places the device into flash mode when the device is powered up)
   ...
   ![Serial adapter wired to a T-Beam for flashing](https://user-images.githubusercontent.com/9000580/168446438-d14f34a0-b92d-4716-87fd-e0c2927a35fd.png)
...
After following the steps above, your device should be in flash mode. You can flash your device using the [manual method](/docs/2.7/getting-started/flashing-firmware/esp32/cli-script)
...
![Serial terminal output confirming Meshtastic installed correctly](https://user-images.githubusercontent.com/9000580/168447159-71a6546a-f487-4bc2-86c1-4c489b2a8975.png)
