...
2. Set the device's role to `TAK` in the [device configuration settings](/docs/2.7/configuration/radio/device/).
...
1. The intervals and behavior of TAK PLI broadcast will honor the settings configured for the standard [Position configuration](/docs/2.7/configuration/radio/position/) in Meshtastic.

2. The callsign sent with the PLI will appear in ATAK with the User [Long Name](/docs/2.7/configuration/radio/user/#long-name) configured for the Meshtastic device.
