...
<div style={{ maxWidth: "800px", margin: "auto" }}>
  <ReactPlayer
    src="https://youtu.be/z_51FAPPl34"
    controls
    width="100%"
    height="400px"
  />
...
To configure our Meshtastic device for this integration, we have a couple of different options, both of which utilize the [Serial module](/docs/2.7/configuration/module/serial):
...
![CalTopo dialog for assigning a label and color to a live track](/img/software/integrations/caltopo/track.webp)
...
![Meshtastic nodes shown on a shared CalTopo map on a mobile device](/img/software/integrations/caltopo/app.webp)
