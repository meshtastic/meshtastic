...
> ⚠️ **Important:** You **must** set your region before transmitting. Operating without the correct region may violate local radio regulations. See the [region configuration guide](https://meshtastic.org/docs/2.7/getting-started/initial-config) on meshtastic.org for details.
...
![IP address field](/img/android/docs/settings_ipv4_field.webp)
...
![Password field](/img/android/docs/settings_password_field.webp)

Settings use standard preference controls — dropdowns, toggles, and sliders:

| Control | Screenshot |
|---------|------------|
| Dropdown | ![Dropdown](/img/android/docs/settings_dropdown.webp) |
| Toggle | ![Toggle](/img/android/docs/settings_switch.webp) |
| Slider | ![Slider](/img/android/docs/settings_slider.webp) |

## Related Topics

- [Settings — Modules & Admin](settings-module-admin.md) — optional feature modules and device administration
- [Signal Meter](signal-meter.md) — how modem presets affect signal quality thresholds
- [LoRa configuration](https://meshtastic.org/docs/2.7/configuration/radio/lora) — detailed LoRa settings reference on meshtastic.org
- [Initial configuration](https://meshtastic.org/docs/2.7/getting-started/initial-config) — region setup guide on meshtastic.org
