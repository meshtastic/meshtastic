...
The CO₂ reading is color-coded by severity (Good → Stuffy → Poor → Unsafe → Evacuate). See [Node Metrics — Air Quality](node-metrics.md#air-quality-metrics) for the exact ppm bands, colors, and AQI detail.
