...
![Welcome screen](/img/android/docs/onboarding_welcome.webp)
...
New to Meshtastic? The [getting started guide](https://meshtastic.org/docs/2.7/getting-started) on meshtastic.org covers hardware selection, initial radio configuration, and your first mesh setup.
