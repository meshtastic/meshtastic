...
- Check that your computer has the required serial drivers installed
  ...
  - You should see something like:
    ...
    - `ID 1a86:55d4 QinHeng Electronics USB Single Serial` for CH9102
      - If there is no seral device shown that matches the device you are using, please review our [Install Serial Drivers](/docs/2.7/getting-started/serial-drivers/) page before proceeding.
...
- Check that your computer has the required serial drivers installed
  ...
  - You should see something like `CP210X USB to UART Bridge Controller`
    - If there is no serial device shown that matches the device you are using, please review our [Install Serial Drivers](/docs/2.7/getting-started/serial-drivers/) page before proceeding.
- Check that your computer has Python 3 installed.
  - Use the command
    ```shell
    python3 -V
