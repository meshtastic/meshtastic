...
| :----------: | :---------------: | :----------------------------------------------------------------------------: |
| `IsLicensed` |      `true`       | See [User Config - IsLicensed](/docs/2.7/configuration/radio/user#is-licensed-ham) |
|  `LongName`  |  _Your CallSign_  |     See [User Config - LongName](/docs/2.7/configuration/radio/user#long-name)     |
| `ShortName`  |  _Abrv CallSign_  |    See [User Config - ShortName](/docs/2.7/configuration/radio/user#short-name)    |
