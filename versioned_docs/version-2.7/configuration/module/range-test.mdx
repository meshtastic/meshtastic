...
When enabled, any previously created `rangetest.csv` file is removed from the device whenever a reboot is invoked; effectively deleting any past test results.
...
2. Navigate to: **Settings >  Range Test**
...
| range_test.clear_on_reboot  |   `true`, `false`   | `false` |
...
See [Google's Import map features from a file instructions](https://support.google.com/mymaps/answer/3024836?co=GENIE.Platform%3DDesktop&hl=en#zippy=%2Cstep-prepare-your-info%2Cstep-import-info-into-the-map).
