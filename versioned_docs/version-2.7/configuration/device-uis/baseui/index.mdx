...
- New Preset Message - Send predefined text messages to the mesh network from the device without using the phone app. To enable this feature, [set a list of predefined messages](/docs/2.7/configuration/module/canned-message/#messages).
