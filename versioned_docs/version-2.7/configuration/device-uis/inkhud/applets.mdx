...
North is always aligned with the top of the screen. The size of each cross indicates how many [hops away](/docs/2.7/overview#how-it-works) a node is. Nodes marked `!` are beyond your [max hops setting](/docs/2.7/configuration/radio/lora#max-hops), making them _unreachable_.
