...
- [Set your LoRa region](/docs/2.7/configuration/region-by-country/)
- [Set your timezone](/docs/2.7/configuration/radio/device#tzdef-timezone-definition)
...
To enable this feature, [set a list of predefined messages](/docs/2.7/configuration/module/canned-message/#messages).
