...
First, [set up the build environment](/docs/2.7/development/firmware/build/#build), then:
...
Install the generated .uf2 file to device using the [drag and drop method](/docs/2.7/getting-started/flashing-firmware/nrf52/drag-n-drop/#nrf52).
...
The general instructions for [building with custom hardware](/docs/2.7/development/firmware/build/#build-with-custom-hardware) apply here.
