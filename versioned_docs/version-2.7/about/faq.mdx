...
export const Faq = {
  general: [
    ...
    },
    {
      ...
      content:
        "Everyone contributes in a different way. Join the [Meshtastic Discord](https://discord.gg/ktMAKGBnBs) and introduce yourself. We're all very friendly. If you'd like to pitch in some code, check out the [Development](/docs/2.7/developers) menu on the left. If you'd like to contribute financially, please visit our page on [Open Collective](https://opencollective.com/meshtastic) or you may choose to [sponsor a developer](https://github.com/sponsors/meshtastic). Check out [Contributing](/docs/2.7/contributing/) for more details.",
    },
  ],
  firmware: [
    {
      title: "Can I update my node's firmware over the mesh?",
      content: `No, Meshtastic does not support OTA updates over LoRa.  Please visit [Flash Firmware](/docs/2.7/getting-started/flashing-firmware/) for update options.`,
    },
    {
    ...
    },
    {
      ...
      content: `Firmware should be kept up to date. While it is not necessary to update whenever a new release comes out it's a good idea to follow the Discord Server and Forums linked in the [Introduction](/docs/2.7/introduction/#contributors) where developers may advise the community about important updates.  The Meshtastic [firmware releases page](https://github.com/meshtastic/firmware/releases) on GitHub has a summary of what has changed in each release.`,
    },
  ],
  android: [
    {
      ...
      content: `Minimum requirement is Android 8 (Oreo August 2017). A good resource to use when researching affordable devices is the [LineageOS Supported Devices List](https://wiki.lineageos.org/devices/).`,
    },
    {
  ...
  apple: [
    ...
    },
    {
      ...
      content: `See [Apple Apps](/docs/2.7/software/apple/)`,
    },
    {
      title:
        "After a fresh firmware install, my node is not connecting via Bluetooth. What should I do?",
  ...
  python: [
    {
      ...
      content: `[See our guide here](/docs/2.7/software/python/cli/installation).`,
    },
    {
      title: "How do I find out more about using python to interact?",
      content: `[See our guide here](/docs/2.7/software/python/cli/usage).`,
    },
    {
      title: "What if I'm still having issues on Windows 10?",
      content:
        "It's been reported that `App execution aliases` might conflict with one another and prevent python3 from being able to run properly. There is an [example of a fix](https://github.com/meshtastic/Meshtastic-gui-installer/issues/154).",
    },
  ],
  devices: [
    {
    ...
    },
    {
      ...
      content: `[T-Beam Buttons](/docs/2.7/hardware/devices/tbeam/buttons) explained here`,
    },
    {
      title: "Where do I purchase the device hardware?",
      content: `Each [supported device](../hardware/devices/index.mdx) has a "Purchase Link".`,
    },
    {
      title:
        "I have my hardware. How do I install the firmware and any required drivers?",
      content: `[See our guide here](/docs/2.7/getting-started).`,
    },
    {
      title: "How do I update the firmware to the latest version?",
      content: `Updating firmware varies with hardware. See [Flashing Firmware](/docs/2.7/getting-started/flashing-firmware).`,
    },
    {
    ...
    },
    {
      ...
      content: `See [Device Power Configuration](/docs/2.7/configuration/radio/power) options.`,
    },
    {
      title:
...
- Lack of Privacy
  - As a ham operator, it is a requirement that you identify yourself by your call sign periodically when transmitting. Your call sign will be publicly transmitted at least once every 10 minutes at minimum. [FCC Part 97.119.A](<https://www.ecfr.gov/current/title-47/chapter-I/subchapter-D/part-97/subpart-B/section-97.119#p-97.119(a)>)
    ...
    {
      title: "How do I set my  call sign?",
      content: `
...
- [Instructions for enabling ham license from the Python CLI](/docs/2.7/software/python/cli/usage#ham-radio-support).
  `,
    },
    {
...
Amateur radio regulations differ significantly across countries, with many prohibiting the use of encryption. Additionally, regulations in some countries restrict licensed operators from relaying messages from unlicensed stations or transmitting messages from licensed stations without including a call sign. These restrictions make interoperability highly impractical, if not impossible. Consequently, interoperability between these modes is not a planned feature.`,
  ...
  modules: [
    ...
    },
    {
      ...
      content: `A list of [available modules](/docs/2.7/configuration/module).`,
    },
    {
      title: "I'd like to write a module. How do I get started?",
      content: `[API documentation for creating modules](/docs/2.7/development/device/module-api).`,
    },
  ],
};
