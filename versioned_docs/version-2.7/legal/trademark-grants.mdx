...
1. **Prepare Your Request**: Review the currently approved trademark grants on this page to understand the typical format and information required. Read https://meshtastic.org/docs/2.7/legal/licensing-and-trademark/ and follow the process to contact trademark@meshtastic.org for review.
...
- Grant: Meshtastic Solutions Inc 
  - Details: Meshtastic Solutions Inc is a company focused on Meshtastic Research and Development and expanding Meshtastic into new industries. Meshtastic Solutions Inc is granted use of all Meshtastic logos and trademarks. Meshtastic Solutions Inc agrees to maintain compliance with all Meshtastic Legal requirements.
