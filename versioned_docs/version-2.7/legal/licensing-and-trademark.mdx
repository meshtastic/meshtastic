...
title: Licensing & Trademark Rules
sidebar_label: Licensing & Trademark
sidebar_position: 3
---
...
Entities with a trademark grant are hereby granted a two-year, non-exclusive and revocable license to use the Meshtastic® logo and trademark on your products or projects, in accordance with our [trademark guidelines](/docs/2.7/legal/licensing-and-trademark#meshtastic-trademark-policy--brand-guidelines). 
...
Alternatively, if you prefer, you can use our community project logos, nicknamed "M-Powered" and "M-PWRD", which are specifically designed for projects that utilize Meshtastic technology. These logos offer a straightforward way to show compatibility with our platform without needing a trademark grant. For more information on these logos, including usage guidelines and design files, please refer to [Community Project Logos: M-Powered & M-PWRD](/docs/2.7/legal/licensing-and-trademark#community-project-logos-m-powered--m-pwrd).
...
- where possible, the design logo hyperlinks to the Meshtastic website, [meshtastic.org](http://meshtastic.org/), or if that is not possible, the site includes a prominent link to the Meshtastic website at [meshtastic.org](http://meshtastic.org/).
- proper trademark symbols are used in connection with the Meshtastic Trademarks and the trademark attribution statement must appear as explained in Proper Trademark Use.
- the Logo Usage Guidelines are strictly observed.
...
- the design logo hyperlinks to the Meshtastic website, [meshtastic.org](http://meshtastic.org/).
- the use does not imply sponsorship or endorsement by Meshtastic.
...
We are excited to introduce two new logos for our community members: the "M-Powered" and "M-PWRD" logos. These logos are designed to be used by projects that are powered by Meshtastic technology, offering an easy way to indicate compatibility with our platform.
...
- **Good Standing Requirement:** Permission to use the M-Powered logo is granted only to individuals or projects that are in good standing within the Meshtastic community. Users who have been banned or are otherwise restricted from community participation due to violations of the [Code of Conduct](https://meshtastic.org/docs/2.7/legal/conduct/) are prohibited from using the M-Powered logo in any form.

We have provided design files for these logos in our [Meshtastic Design repository](https://github.com/meshtastic/design/tree/master/Meshtastic%20Powered%20Logo).
...
Community members have asked whether it is permissible to use the Meshtastic trademarks, including the term “Meshtastic,” in an Internet domain name. This is not allowed at this time.

Instead, many community groups have found success using alternative domain names that do not directly incorporate the trademark. Examples include:
- https://bayme.sh/
...
- The adding our logo or other marks to a non-software good may be allowed, with written permission from the Meshtastic Trademark Supervisor, provided that the non-software good is a 100% original design or the requester has evidence of a grant of use from copyright holder of the original design.
...
- The Meshtastic Logo must be hyperlinked to [meshtastic.org](http://meshtastic.org/), in contexts where such a hyperlink is technically feasible.
...
The Meshtastic logo is a trademark of Meshtastic LLC. In order to protect and grow the Meshtastic brand, we have a distinguishable logo. When displaying the Meshtastic logo, please follow our standard Trademark Guidelines. There are [other sizes and resolutions of the logo](https://github.com/meshtastic/design) and some are suitable for print.

To join the discussion about Meshtastic Trademark policies, and participate in shaping future policy visit the [Meshtastic Discussions](https://github.com/orgs/meshtastic/discussions) page or [Meshtastic Discord](https://discord.com/invite/ktMAKGBnBs).
