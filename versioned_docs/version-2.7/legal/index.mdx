...
**Encryption and Security:** Our encryption measures are robust and a significant aspect of our project. However, it's important to recognize the limitations and risks associated with any encryption technology. For further understanding of these aspects, kindly review [encryption](/docs/2.7/overview/encryption).
...
All commercial use must comply with the terms of the GPLv3 license and the Meshtastic [trademark guidelines](./licensing-and-trademark.mdx).
