...
1. Verify your WSL Linux distribution is greater than 5.10.60.1. 
...
Refer to [Linux install instructions](/docs/2.7/meshtasticd/installation/ubuntu) for your respective distro. In this example, we will be using Ubuntu.
