...
- **[Firmware](/docs/2.7/development/firmware)**: [building the firmware](/docs/2.7/development/firmware/build), platform guides, and [port numbers](/docs/2.7/development/firmware/portnum).
- **[Device APIs](/docs/2.7/development/device)**: the [Client API](/docs/2.7/development/device/client-api), [Module API](/docs/2.7/development/device/module-api), and HTTP API for talking to (or running code on) devices.
- **[Android](/docs/2.7/software/android/developer/)**: the developer guide for the Android app.
- **[Apple](/docs/2.7/software/apple/developer/)**: the developer guide for the iOS, iPadOS, and macOS apps.
- **[Web Client](/docs/2.7/development/web)**: the hosted and on-device web interface.
- **[JavaScript](/docs/2.7/development/js)** and **[Python](/docs/2.7/development/python)**: libraries (and the Python CLI) for building applications that interface with Meshtastic devices.
- **[Linux](/docs/2.7/development/linux)**: building and packaging Meshtastic for Linux.
- **[Documentation](/docs/2.7/development/docs)**: how this site is built, how to contribute to it, and [guidelines for writing for the Meshtastic blog](/docs/2.7/development/documentation/blog/).
- **[Reference Material](/docs/2.7/development/reference)**: [protobufs](/docs/2.7/development/reference/protobufs), LoRa design, encryption details, and [GitHub setup](/docs/2.7/development/reference/github).
- **[GitHub](/docs/2.7/development/github)**: how the project uses GitHub across its 100+ repositories.
