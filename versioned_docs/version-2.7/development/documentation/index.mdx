...
All of our documentation resides on GitHub. See [instructions for setting up your GitHub account](../reference/github.mdx).
...
Another component that we use is [Vercel](https://vercel.com) — a platform for front-end frameworks and static sites. See [instructions for setting up your instance of Vercel](./publish.mdx#publish-to-vercel).
...
Assuming you have the [prerequisites installed](./local-dev.mdx#prerequisites), running a local instance of Docusaurus takes three steps:
