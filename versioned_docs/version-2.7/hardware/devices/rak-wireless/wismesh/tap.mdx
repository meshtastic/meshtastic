...
- **MCU**
  - [RAK4631 (nRF52840)](/docs/2.7/hardware/devices/rak-wireless/wisblock/core-module?rakcore=RAK4631)
    - Bluetooth BLE 5.0
...
- GNSS location module onboard ([RAK12500](/docs/2.7/hardware/devices/rak-wireless/wisblock/peripherals?rakmodules=GPS))
...
- **MCU**
  - [RAK3312 (ESP32-S3)](/docs/2.7/hardware/devices/rak-wireless/wisblock/core-module?rakcore=RAK3312)
    - 2.4GHz Wi-Fi b/g/n
    - Bluetooth BLE
- **LoRa Transceiver:**
  - Semtech SX1262
