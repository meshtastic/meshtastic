...
Channel | [Configuration](/docs/2.7/configuration/radio/channels/) | [Frequency Calculator](/docs/2.7/overview/radio-settings/#frequency-slot-calculator)
...
CLI | [Guide](/docs/2.7/software/python/cli/)
...
DFU
: Device Firmware Update, a state in which a device is placed into for it to receive a firmware update

ESP32 | [Drivers](/docs/2.7/getting-started/serial-drivers/esp32/) | [Firmware](/docs/2.7/getting-started/flashing-firmware/esp32/)
...
Firmware | [Guide](https://meshtastic.org/docs/2.7/getting-started/flashing-firmware/)
...
Flash/Flashing | [Guide](https://meshtastic.org/docs/2.7/getting-started/flashing-firmware/)
...
LoRa
: A low-power, long-range wireless communication technology used by Meshtastic devices to enable communication over distances of several kilometers without the need for cellular, WiFi, or other traditional network infrastructures.

LoS
: Line of Sight, a pathway through only air between two points.

Mesh | [Algorithm](/docs/2.7/overview/mesh-algo/)
...
Module | [Software Modules](/docs/2.7/configuration/module/) | [Hardware Modules](/docs/2.7/hardware/devices/)
...
[MQTT](/docs/2.7/software/integrations/mqtt/)
...
NRF52 | [Drivers](/docs/2.7/getting-started/serial-drivers/nrf52/) | [Firmware](/docs/2.7/getting-started/flashing-firmware/nrf52/)
...
OTA
: Abbreviation for "Over the Air". Typically used to refer to a OTA update which is one that happens over a wireless network (over the air). 
...
Protobuf | [Reference](/docs/2.7/development/reference/protobufs/)
...
Pre-Shared Key (PSK) | [Encryption](/docs/2.7/overview/encryption/)
...
Public Key Cryptography (PKC) | [Encryption](/docs/2.7/overview/encryption/)
...
Repeater | [Role Definitions](/docs/2.7/configuration/radio/device/#roles)
: Infrastructure node for extending network coverage by relaying messages with minimal overhead. Not visible in Nodes list.

Router | [Role Definitions](/docs/2.7/configuration/radio/device/#roles)
