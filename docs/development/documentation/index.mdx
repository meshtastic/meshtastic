...
All of our documentation resides on GitHub. See [instructions for setting up your GitHub account](/docs/development/reference/github).
...
Another component that we use is [Vercel](https://vercel.com) — a platform for front-end frameworks and static sites. See [instructions for setting up your instance of Vercel](/docs/development/documentation/publish#publish-to-vercel).
