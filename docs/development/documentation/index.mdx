...
All of our documentation resides on GitHub. Instructions for setting up your GitHub account are located [here](../development/reference/github).
...
Another component that we use is [Vercel](https://vercel.com) — a platform for front-end frameworks and static sites. Instructions for setting up your instance of Vercel are located [here](../development/documentation/publish#publish-to-vercel).
...
Assuming you have the [prerequisites installed](../development/documentation/local-dev#prerequisites), running a local instance of Docusaurus takes three steps:
