...
<Tabs groupId="operating-systems" queryString="os">
  ...
  ```shell
  # Base dependencies
  sudo apt install libgpiod-dev libyaml-cpp-dev libjsoncpp-dev libbluetooth-dev libusb-1.0-0-dev libi2c-dev libuv1-dev libxkbcommon-dev libinput-dev libsqlite3-dev libbsd-dev
