...
- **[Android](/docs/software/android/developer/)**: the developer guide for the Android app.
- **[Apple](/docs/software/apple/developer/)**: the developer guide for the iOS, iPadOS, and macOS apps.
...
To support the project financially, or to write for the Meshtastic blog, see [Contributing to Meshtastic](/docs/contributing/).
