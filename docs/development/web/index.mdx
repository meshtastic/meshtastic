...
The version served from a node can be accessed by first [connecting your node to your network](../../configuration/radio/network) and then navigating to http://meshtastic.local (or your_node_ip.local).
