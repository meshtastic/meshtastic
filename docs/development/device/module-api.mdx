...
For initial testing, implement handleReceived() so your code runs on every packet to your port. If you prefer reply-on-request behavior, test allocReply() with a client that can set want_response = true.
