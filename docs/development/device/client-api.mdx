...
This document describes the protocol for external API clients using our devices. If you are interested in running your own code on the device itself, see the [module API](../../development/device/module-api) documentation instead.
