...
[over SWD](/docs/getting-started/flashing-firmware/stm32/flashing-over-swd),
...
4. Flash the Meshtastic firmware as described in
   ...
   or [Flashing over UART](/docs/getting-started/flashing-firmware/stm32/flashing-over-uart)
