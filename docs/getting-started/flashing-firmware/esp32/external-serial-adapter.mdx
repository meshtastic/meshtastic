...
:::info
This information will likely only be helpful if you've already attempted to go through the prerequisites and processes outlined in [manually flashing](../../../getting-started/flashing-firmware/esp32/cli-script)
:::
...
After following the steps above, your device should be in flash mode. You can flash your device using the [manual method](../../../getting-started/flashing-firmware/esp32/cli-script)
