...
6. Connect to the device via serial console using the [Meshtastic CLI `--noproto`](../../../software/python-cli/index.mdx#--noproto) mode or a standalone serial client like `minicom`.
