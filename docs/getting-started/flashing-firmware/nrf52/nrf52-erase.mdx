...
3. Put the device into [bootloader mode](/docs/getting-started/flashing-firmware/nrf52/drag-n-drop/#bootloader-mode). On most devices, double-press the reset button.
