...
6. Connect to the device via serial console using the [Meshtastic CLI `--noproto`](../../../software/python/cli/#--noproto) mode or a standalone serial client like `minicom`.
