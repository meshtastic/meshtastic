...
Follow the guide to [factory erase your nRF52](../../../getting-started/flashing-firmware/nrf52/nrf52-erase) device before continuing to [flash firmware](#flash-firmware).
