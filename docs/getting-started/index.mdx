...
This guide assumes that you have already purchased the devices you will be using with Meshtastic. If you haven't, you can check out our list of [supported hardware](supported-hardware/)
to see your options.
:::
...
If your device is not listed above, please review our [supported devices](supported-hardware) to determine which MCU your device has or contact us in [Discord](https://discord.gg/ktMAKGBnBs) with any questions.
...
<div className="indexCtasBody">
  <div className="split-container">
    <div className="split-item">
      <Link
        ...
        to={'getting-started/serial-drivers/esp32'}
      >
  ...
  <div className="split-item">
      <Link
        className={'button button--outline button--lg cta--button'}
        to={'getting-started/serial-drivers/nrf52'}
      >
...
<div className="indexCtasBody">
  <div className="split-container">
    <div className="split-item">
      <Link
        className={"button button--outline button--lg cta--button"}
        to={"getting-started/flashing-firmware/esp32/"}
      >
  ...
  <div className="split-item">
      <Link
        className={"button button--outline button--lg cta--button"}
        to={"getting-started/flashing-firmware/nrf52/"}
      >
...
<div className="indexCtasBody">
  <Link
    className={"button button--outline button--lg cta--button"}
    to={"getting-started/initial-config"}
  >
    Connect and Configure Device
  </Link>
</div>
