...
Currently (as of 8/31/2023), The Silicon Labs CP210X Drivers page does not have any downloads available, however they are still available on the [Internet Archive](https://web.archive.org/web/20230711171140/https://www.silabs.com/developers/usb-to-uart-bridge-vcp-drivers?tab=downloads).
