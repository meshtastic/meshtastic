...
- Make sure that your cable is not only for charging but also for [data transfer](../../getting-started/index.mdx(../../getting-started/index.mdx#verify-data-cable).
- It's possible that you need to [reinstall the USB serial driver](../../getting-started/serial-drivers/).
