...
- [Python CLI](../software/python/cli/)
- [Web Client](https://client.meshtastic.org)
- [Android App](../category/android-app)
...
- [Android App](../category/android-app)
- [Web Client](https://client.meshtastic.org)
- [iOS/iPadOS/macOS App](../category/apple-apps)
...
1. Follow the [installation](../software/android/installation) and [usage](../software/python/cli/usage) instructions for [Meshtastic Android](../category/android-app).
...
1. Install [Meshtastic PythonCLI](../software/python/cli/installation)
   ```sh
