...
- [Android App](/docs/software/android/user/)
...
- [Web Client](https://client.meshtastic.org)
- [Android App](/docs/software/android/user/)
- [iOS App](/docs/software/apple/user/)
- [Python CLI](/docs/software/python/cli/)
...
1. Follow the [setup and usage instructions](/docs/software/android/user/) for [Meshtastic Android](/docs/software/android/).
