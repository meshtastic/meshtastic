...
export const Faq = {
  ...
  : [
    {
      title: "What is the benefit of using a  license with Meshtastic?",
      content: `
If you use your  radio license with Meshtastic, consider both the privileges and restrictions:
#### Privileges
