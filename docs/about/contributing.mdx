...
- Optimize and compress images using tools like [Tinify/TinyPng](https://tinypng.com/) to improve load times.
...
- Aim to maintain high-quality, accessible writing that reflects the collaborative spirit of Meshtastic.

#### Length

- Aim for posts to be at least 500 to 700 words.
