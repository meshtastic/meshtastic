...
Meshtastic carries text messages and position reports across a wireless mesh of nodes, using LoRa and no internet or cellular service. The sections below define what a mesh is, follow a message from your client to the nodes that relay it, and describe what a packet looks like on the air.
