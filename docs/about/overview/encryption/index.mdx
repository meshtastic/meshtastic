...
The device will decrypt the payload before sending it to a client app via BLE, serial, WiFi/Ethernet. For MQTT, you can [specify](/docs/configuration/module/mqtt#encryption-enabled) whether you want to send an encrypted or unencrypted payload.
