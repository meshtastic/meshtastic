...
Other protocols, such as _misconfigured TLS1.2_, are far more impacted by Harvest now, Decrypt later attacks because their keys will be broken by near-future Quantum-Computers, thus they do not provide PFS.
...
- Admin Messages between two v2.5.0 or newer nodes are now protected and additional relay attack protection in place.
