...
- [Colorado Mesh Mesh Client](/docs/community/software/colorado-mesh-mesh-client) - Cross-platform Electron desktop client for Meshtastic and MeshCore on macOS, Linux, and Windows with BLE, USB serial, Wi-Fi/TCP, MQTT, multi-language support, local SQLite history, routing diagnostics, PKI, interactive map, telemetry charts, and TAK Server integration.
