...
- [Mesh-metrics](/docs/community/software/community-mesh-metrics) - Meshtastic repeater metrics scraper using meshttastic-cli to be ingrested by node_exporter for use in Prometheus//VictoriaMetrics TDB with a Grafana dashboard and sample alerting rules.

Support for these projects should be sought from their respective authors.
community-mesh-metrics
