...
- [Connect](https://github.com/pdxlocations/connect) - A nodeless python client for communicating with Meshtastic devices over MQTT.
- [Contact](https://github.com/pdxlocations/contact) - A console chat client for Meshtastic devices. Built with the curses library.
- [Control](https://github.com/pdxlocations/control) - A console configuration client for Meshtastic devices. Based on with the Meshtastic python library.
