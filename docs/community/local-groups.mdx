...
:::info Important
To be listed here, your group must be in compliance with our [Trademark Guidlines](https://meshtastic.org/docs/legal/licensing-and-trademark/#social-media).
- Groups may only use the Meshtastic logo if it is in a secondary position to the group's primary branding
- Groups may not use "Meshtastic [insert location]" in their link, group name or site title, as this may imply official sponsorship.
