...
- Groups may use the Meshtastic logo if it is in a secondary position to the group's primary branding.  If in doubt, use the [M-Powered Logo](https://github.com/meshtastic/design/tree/master/Meshtastic%20Powered%20Logo) or your own creation.
...
- Also, please be sure server invitation links are set to not expire.
:::
