...
- You can use the document below to intepret the info using this [Meshtastic Screen Info Starter Guide ](FMeshtastic-Screen-Info-Quick-Starter-Guide-Version1.pdf)
