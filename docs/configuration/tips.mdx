...
For a mobile deployment with a single node either on your person or in a vehicle, use the CLIENT_MUTE role as either doesn't need to participate in packet routing.
