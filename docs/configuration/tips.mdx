...
To mute a channel, see: [channel.mute](/docs/configuration/radio/channels/#is-muted)
...
If a particular node is bothering you and you don't want to receive their messages at all, try [ignoring a node](/docs/configuration/radio/lora#ignore-incoming-array). Which can be performed through the various client applications.
