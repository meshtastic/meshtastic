...
| Brazil             | ANZ<br />BR_902    | [Brazilian Regulations](https://www.gov.br/anatel/pt-br/regulado/radiofrequencia/radiacion-restrita) |
...
> **Ecuador:** The `ANZ` region matches Ecuador's 915–928 MHz frequency range, but does not encode all Ecuador-specific regulatory restrictions. ARCOTEL limits peak transmitter power in this band to 27 dBm and requires spread-spectrum transmissions. Users must comply with the applicable ARCOTEL requirements when operating in Ecuador.
