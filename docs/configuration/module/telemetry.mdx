...
### Environment Telemetry Enabled <CompatibilityIcons configKey="telemetry_environment_measurement_enabled" />

Enable the Environment Telemetry (Sensors).

### Environment Metrics Update Interval <CompatibilityIcons configKey="telemetry_environment_update_interval" />

How often we should send Environment(Sensor) Metrics over the mesh.

Default is `1800` seconds (30 minutes).

### Device Metrics Update Interval <CompatibilityIcons configKey="telemetry_device_update_interval" />
...
### Environment Screen Enabled <CompatibilityIcons configKey="telemetry_environment_screen_enabled" />

Show the environment telemetry data on the device display.

Default is `false`.

### Display Fahrenheit <CompatibilityIcons configKey="telemetry_environment_display_fahrenheit" />
...
### Air Quality Enabled <CompatibilityIcons configKey="telemetry_air_quality_enabled" />
...
### Air Quality Interval <CompatibilityIcons configKey="telemetry_air_quality_interval" />
...
### Power Metrics Enabled <CompatibilityIcons configKey="telemetry_power_measurement_enabled" />
...
### Power Metrics Interval <CompatibilityIcons configKey="telemetry_power_update_interval" />
...
### Health Telemetry Enabled <CompatibilityIcons configKey="telemetry_health_measurement_enabled" />

This option is used to enable/disable the sending of health data from an attached supported sensor over the mesh network.

Default is `false`.

### Health Telemetry Interval <CompatibilityIcons configKey="telemetry_health_update_interval" />
