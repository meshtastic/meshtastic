...
### Enabled <CompatibilityIcons configKey="remote_hardware_enabled" />

Whether the module is enabled.

### Allow Undefined Pin Access <CompatibilityIcons configKey="remote_hardware_allow_undefined_pin_access" />

Whether the Module allows consumers to read / write to pins not defined in available_pins

### Available Pins <CompatibilityIcons configKey="remote_hardware_available_pins" />
