...
You can programmatically do operations from your own python code by using the Meshtastic `RemoteHardwareClient` class. See the [Python API](../../software/python/cli/installation) documentation for more details.
