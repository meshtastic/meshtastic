...
:::info
Store and Forward Config options are available for iOS client.

All Store and Forward Module config options are available on iOS, iPadOS and macOS app versions 2.2.3 and higher at 
Settings > Module Configuration > Store & Forward
:::
