...
### Enabled <CompatibilityIcons configKey="store_forward_enabled" />

Enables the module.

### Heartbeat <CompatibilityIcons configKey="store_forward_heartbeat" />
...
### History Return Max <CompatibilityIcons configKey="store_forward_history_return_max" />

Sets the maximum number of messages to return to a client device when it requests the history.

### History Return Window <CompatibilityIcons configKey="store_forward_history_return_window" />

Limits the time period (in minutes) a client device can request.

### Records <CompatibilityIcons configKey="store_forward_records" />
...
### Is server <CompatibilityIcons configKey="store_forward_is_server" />
