...
### Enabled <CompatibilityIcons configKey="range_test_enabled" />
...
### Sender Interval <CompatibilityIcons configKey="range_test_sender" />
...
### Save CSV File <CompatibilityIcons configKey="range_test_save" />
