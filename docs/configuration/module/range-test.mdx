...
This module allows you to test the range of your Meshtastic nodes. It requires two nodes, only nodes that have the module enabled will see the range test messages:
