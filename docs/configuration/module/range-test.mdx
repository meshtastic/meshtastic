...
For tips on keeping your location private, see: [Configuration Tips Not Sharing your Location](/docs/configuration/tips/#not-sharing-your-location)  Also see the page on [position precision](/docs/configuration/radio/channels/#position-precision).
