...
Popular mapping examples that support .csv files directly would be Google Earth Pro, Google My Maps, and OpenStreetMaps uMap. See [Mapping Application Examples](/docs/configuration/module/range-test/#application-examples) below. Alternatively .csv files can be converted beforehand into other file types that your preferred mapping application supports.
