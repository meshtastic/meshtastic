...
### Enabled <CompatibilityIcons configKey="mqtt_enabled" />

Enables the MQTT module.

### Server Address <CompatibilityIcons configKey="mqtt_address" />

The server to use for MQTT. If not set, the default public server will be used.

### Username <CompatibilityIcons configKey="mqtt_username" />
...
### Password <CompatibilityIcons configKey="mqtt_password" />
...
### Encryption Enabled <CompatibilityIcons configKey="mqtt_encryption_enabled" />
...
### JSON Enabled <CompatibilityIcons configKey="mqtt_json_enabled" />
...
### TLS Enabled <CompatibilityIcons configKey="mqtt_tls_enabled" />

If true, we attempt to establish a secure connection using TLS.

### Root Topic <CompatibilityIcons configKey="mqtt_root" />
...
### Client Proxy Enabled <CompatibilityIcons configKey="mqtt_proxy_to_client_enabled" />
...
### Map Reporting Enabled <CompatibilityIcons configKey="mqtt_map_reporting_enabled" />
...
### Map Report Position Precision <CompatibilityIcons configKey="mqtt_map_report_settings_position_precision" />

The precision to use for the position in the map report. Defaults to a maximum deviation of around 1459m.

### Map Report Publish Interval <CompatibilityIcons configKey="mqtt_map_report_settings_publish_interval_secs" />
