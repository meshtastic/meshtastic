...
### Enabled <CompatibilityIcons configKey="neighbor_info_enabled" />

Enables the Neighbor Info Module.

### Update Interval <CompatibilityIcons configKey="neighbor_info_update_interval" />
...
### Transmit Over LoRa <CompatibilityIcons configKey="neighbor_info_transmit_over_lora" />
