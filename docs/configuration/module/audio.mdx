...
### Codec2 Enabled <CompatibilityIcons configKey="audio_codec2_enabled" />

Enables the audio module.

### PTT GPIO <CompatibilityIcons configKey="audio_ptt_pin" />

The GPIO to use for the Push-To-Talk button. The default is GPIO 39 on the ESP32.

### Audio Bitrate/Codec Mode <CompatibilityIcons configKey="audio_bitrate" />
...
### I2S Word Select <CompatibilityIcons configKey="audio_i2s_ws" />

The GPIO to use for the WS signal in the I2S interface.

### I2S Data IN <CompatibilityIcons configKey="audio_i2s_sd" />

The GPIO to use for the SD signal in the I2S interface.

### I2S Data OUT <CompatibilityIcons configKey="audio_i2s_din" />

The GPIO to use for the DIN signal in the I2S interface.

### I2S Clock <CompatibilityIcons configKey="audio_i2s_sck" />
