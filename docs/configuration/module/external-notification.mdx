...
### Enabled <CompatibilityIcons configKey="external_notification_enabled" />

Enables the external notification module.

### Active (general / LED only) <CompatibilityIcons configKey="external_notification_output" />
...
### Alert when receiving a bell (general / LED, Vibra and Buzzer) <CompatibilityIcons configKey="external_notification_alert_bell" />

Specifies if an alert should be triggered when receiving an incoming bell.

### Alert when receiving a message (general / LED, Vibra and Buzzer) <CompatibilityIcons configKey="external_notification_alert_message" />

Specifies if an alert should be triggered when receiving an incoming message.

### GPIO Pins (general / LED, Vibra and Buzzer) <CompatibilityIcons configKey="external_notification_enabled" />
...
### How long monitored GPIO is triggered <CompatibilityIcons configKey="external_notification_output_ms" />
...
### Repeat (Nag Timeout) (general / LED, Vibra and Buzzer) <CompatibilityIcons configKey="external_notification_nag_timeout" />
