...
|           [Mesh Beacon](/docs/configuration/module/mesh-beacon)            |                                                     Advertise your mesh to nodes that are not on it yet, optionally offering a channel, region and modem preset to join on.                                                     |
