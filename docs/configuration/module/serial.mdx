...
- `LOG` will output a short, formatted log of packets sent or recieved by the node, including text, and telemetry packets.
- `LOGTEXT` will output a short, formatted log of every text packet sent or recieved by the node.
