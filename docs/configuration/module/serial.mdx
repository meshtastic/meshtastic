...
### Enabled <CompatibilityIcons configKey="serial_enabled" />

Enables the serial module.

### Echo <CompatibilityIcons configKey="serial_echo" />

If set, any packets you send will be echoed back to your device.

### Mode <CompatibilityIcons configKey="serial_mode" />
...
### Receive GPIO Pin <CompatibilityIcons configKey="serial_rxd" />
...
### Transmit GPIO Pin <CompatibilityIcons configKey="serial_txd" />
...
### Baud Rate <CompatibilityIcons configKey="serial_baud" />

The serial baud rate.

### Timeout <CompatibilityIcons configKey="serial_timeout" />

The amount of time to wait before we consider your packet as "done".

### Override Console Serial Port <CompatibilityIcons configKey="serial_override_console_serial_port" />
