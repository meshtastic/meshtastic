...
The main channel tab can be used for common tasks:
...
The Channels menu has additional options:

Navigate to **Vertical Ellipsis (3 dots top right) > Radio Configuration > Channels**
