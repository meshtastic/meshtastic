...
|      Value      |                                                                                                                                                                                                                                                                                Description                                                                                                                                                                                                                                                                                 |
| :-------------: | :-----------------------------------------------------------------------: | : -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|    `CLIENT`     |  SUMMARY EXAMPLE AREA |                                                                                                                                                                                               Client (default) - This role will follow the standard routing rules while also allowing the device to interact with client applications via BLE/Wi-Fi (Android/Apple/Web).                                                                                                                                                                                                 |
