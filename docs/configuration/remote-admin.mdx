...
For further reading, I recommend starting out with the [Meshtastic Python CLI Guide](../software/python-cli/index.mdx) if you haven't already gone through this (hopefully you have since you are reading this). But for a full reference to the settings you can change, please see:

[Settings Overview](../configuration/) and
[Complete list of user settings in Protobufs](https://buf.build/meshtastic/protobufs../main:meshtastic#meshtastic.User)