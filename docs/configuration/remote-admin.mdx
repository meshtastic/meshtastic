...
2. Go to **Settings**.
3. Under **App Settings**, enable **Administration**.
4. Select the node you want to manage under **Settings > Configure Node**.
5. Supported Radio and Module settings for the remote node will be accessible from the **Settings** screen.
6. When finished administering the remote node, select your own node again in Settings > Configure Node.
