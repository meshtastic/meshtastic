...
### Enabled <CompatibilityIcons configKey="bluetooth_enabled" />

Enables Bluetooth.

### Pairing Mode <CompatibilityIcons configKey="bluetooth_pairing_mode" />
...
### Fixed PIN <CompatibilityIcons configKey="bluetooth_fixed_pin" />
