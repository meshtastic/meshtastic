...
:::info
**Channel Settings** (as described on this page) should not be confused with [Modem Preset Settings](../../configuration/radio/lora#modem-preset)

[Modem Preset Settings](../../configuration/radio/lora#modem-preset) contain the modem configuration (frequency settings, spreading factor, bandwidth, etc.) used for the LoRa radio. These settings are identical for all channels and can **not** be unique per channel.
...
See [Android App Usage](../../software/android/usage#setup-a-channel) for more further instruction on setting up your primary channel.
...
For configuring gateways, please see [MQTT](../../configuration/module/mqtt)
