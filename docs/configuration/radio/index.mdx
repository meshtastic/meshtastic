...
|  [Security](/docs/configuration/radio/security)  |                              Security config options are: Public Key, Private Key, Admin Key, Is Managed, Serial Console, Debug Logs, and Admin Channel.                              |
