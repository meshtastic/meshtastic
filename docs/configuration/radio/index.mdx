...
|   [Network](./network)   |                                               The network config options are: Wi-Fi Enabled, Wi-Fi SSID, Wi-Fi PSK, Wi-Fi Mode and NTP Server.                                                |
...
|      [User](./user)      |                                                            The user config options are: Long Name, Short Name, Is Licensed, and Is Unmessageable                                          |
