...
| CLIENT_HIDDEN  | Device that only broadcasts as needed for stealth or power savings.                                                       | Use in clandestine operations or to reduce airtime/power consumption while still participating in the network.                         |
