...
Note: Devices using the "ROUTER" role will have unreliable serial access, as it is disabled when the device enters sleep. To keep serial active, consider switching to ROUTER_CLIENT.
