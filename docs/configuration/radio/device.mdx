...
| `LOST_AND_FOUND` |                                                                                                                                                                                                  Lost and Found - Used to automatically send a text message to the default channel of the device with the current position of the device on a frequent interval: "I'm lost! Position: lat / long"                                                                                                                                                                                                   |
