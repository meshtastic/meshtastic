...
The device config options are: Role, Rebroadcast Mode, Timezone, GPIOs, Buttons, and LEDs. Device config uses an admin message sending a `Config.Device` protobuf.
