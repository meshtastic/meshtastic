...
### Roles <CompatibilityIcons configKey="device_role" />
...
### Rebroadcast Mode <CompatibilityIcons configKey="device_rebroadcast_mode" />
...
### GPIO for User Button <CompatibilityIcons configKey="device_button_gpio" />
...
### GPIO for PWM Buzzer <CompatibilityIcons configKey="device_buzzer_gpio" />

This is the GPIO pin number that will be used for the PWM buzzer, if your device does not come with a predefined buzzer.


### PWM Buzzer Mode <CompatibilityIcons configKey="device_buzzer_mode" />

### Node Info Broadcast Seconds <CompatibilityIcons configKey="device_nodeinfo_broadcast_secs" />
...
### Double Tap as Button Press <CompatibilityIcons configKey="device_double_tap_as_button_press" />
...
### Disable Triple Click <CompatibilityIcons configKey="device_disable_triple_click" />

Disables the triple-press of user button to enable or disable GPS.

### TZDEF (Timezone Definition) <CompatibilityIcons configKey="device_tzdef" />
...
### LED Heartbeat Disabled <CompatibilityIcons configKey="device_led_heartbeat_disabled" />
