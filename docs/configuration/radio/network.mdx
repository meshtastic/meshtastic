...
description: Learn about network configuration for your Meshtastic device including NTP, Wi-Fi, and Ethernet.
---
...
:::warning
Setting Wi-Fi credentials, or performing any other local administration, over an untrusted Wi-Fi network exposes that traffic to the network. See [Local Administration Over Wi-Fi](/docs/development/reference/encryption-technical#local-administration-over-wi-fi) for the trust-boundary details.
:::
