...
:::info
LoRa Channel Configuration should not to be confused with messaging [Channel Configuration](../radio/channels). See [Chat Channels VS Lora Modem Channels](../tips#chat-channels-vs-lora-modem-channels) for further clarification.
:::
