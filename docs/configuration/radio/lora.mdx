...
import LoRaRegions from "../../../docs/blocks/_lora-regions.mdx";
...
:::info
LoRa Channel Configuration should not to be confused with messaging [Channel Configuration](../../configuration/radio/channels). See [Chat Channels VS Lora Modem Channels](../../configuration/tips#chat-channels-vs-lora-modem-channels) for further clarification.
:::
