...
## Security Keys - Backup and Restore
 ...
 Backing up your security keys (private and public) are vital to the long term sustainability of your node on the mesh. Once your node is on the mesh with a set of security keys, it is your responsibility to ensure these keys are maintained.
