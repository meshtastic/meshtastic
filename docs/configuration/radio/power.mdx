...
### Power Saving <CompatibilityIcons configKey="power_is_power_saving" />
...
### Shutdown after losing power <CompatibilityIcons configKey="power_on_battery_shutdown_after_secs" />
...
### ADC Multiplier Override <CompatibilityIcons configKey="power_adc_multiplier_override" />
...
### Wait Bluetooth Interval <CompatibilityIcons configKey="power_wait_bluetooth_secs" />

How long to wait before turning off BLE in no Bluetooth states

`0` for default of 1 minute

### Light Sleep Interval <CompatibilityIcons configKey="power_ls_secs" />
...
### Minimum Wake Interval <CompatibilityIcons configKey="power_min_wake_secs" />
...
### Device Battery INA2xx Address <CompatibilityIcons configKey="power_device_battery_ina_address" />
