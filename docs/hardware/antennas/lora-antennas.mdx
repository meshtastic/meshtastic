...
Devices on another frequency will not be able to interact with yours. See this listing by [The Things Network](https://www.thethingsnetwork.org../lorawan/frequencies-by-country.html) for frequencies licensed for specific countries.
