...
The Raspberry Pi Pico series is a range of tiny, fast, and versatile boards built using RP2040 and RP2350, microcontroller chips designed by Raspberry Pi in the UK.
...
- Firmware file:`firmware-pico-X.X.X.xxxxxxx.uf2`
  ...
  - for Pico 2 use: `firmware-pico2-X.X.X.xxxxxxx.uf2`
  - for Pico 2 W use: `firmware-pico2w-X.X.X.xxxxxxx.uf2`
