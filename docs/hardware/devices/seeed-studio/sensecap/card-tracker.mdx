...
Currently, this device is not supported in Meshtastic. There is no way to use the tracker functions.
Seed studio tech support doesn't offer any solutions to the problem.
:::
