...
- **User/Program Button (face):**
  ...
  - **Hold for 3 seconds while the device starts:** Enters [bootloader mode](/docs/getting-started/flashing-firmware/nrf52/drag-n-drop/#bootloader-mode) on the Meshtastic OTAFIX bootloader 2.5 or later. A hold while the firmware is running doesn't.
