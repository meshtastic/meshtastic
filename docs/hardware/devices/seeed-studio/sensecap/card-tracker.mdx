...
On the bootloader Seeed ships, the button doesn't reach bootloader mode. Follow [Seeed's T1000-E guide](https://wiki.seeedstudio.com/sensecap_t1000_e/) to enter it, or [update the bootloader](/docs/getting-started/flashing-firmware/nrf52/update-nrf52-bootloader/) first. To skip the button entirely on any bootloader, connect the device over USB and run `meshtastic --enter-dfu`. [Entering bootloader mode](/docs/getting-started/flashing-firmware/nrf52/entering-bootloader-mode/) covers every method.
