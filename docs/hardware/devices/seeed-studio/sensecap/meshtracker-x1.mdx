...
- User button and RGB status LED. Holding the button for 3 seconds while the device starts enters [bootloader mode](/docs/getting-started/flashing-firmware/nrf52/drag-n-drop/#bootloader-mode) on the Meshtastic OTAFIX bootloader 2.5 or later; there is no reset button.
