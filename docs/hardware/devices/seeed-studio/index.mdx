...
The SenseCAP product line offers a comprehensive range of solutions for both hobbyists and industrial users, featuring the T1000-E card tracker, an IP65-rated, ready-to-go Meshtastic handheld device, the Indicator with a 4-inch touchscreen driven by ESP32-S3 and RP2040 Dual-MCU, the Solar Node, a solar-powered device designed for long-term outdoor deployment, and the MeshTracker X1, an IP66-rated card-sized tracker with dual-band GNSS. These devices are designed to be user-friendly, with pre-flashed Meshtastic firmware for easy setup and operation.
...
| [MeshTracker X1](./sensecap/meshtracker-x1/)     | nRF52840      | LR2021 | NO           | 5.0 | YES      |
