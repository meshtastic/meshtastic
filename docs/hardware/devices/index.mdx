...
Meshtastic firmware can be installed on a wide range of Meshtastic specific devices as well as development boards. The list below provides a brief comparison of currently supported hardware.
