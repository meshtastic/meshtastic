...
The SenseCAP product line offers a comprehensive range of solutions for both hobbyists and industrial users, featuring the T1000-E card tracker, an IP65-rated, ready-to-go Meshtastic device, and the Indicator with a 4-inch touchscreen driven by ESP32-S3 and RP2040 Dual-MCU.
...
The Seeed XIAO + SX1262 development kit series offers compact devices with multiple MCU options, and plenty of GPIOs to attach sensors or other hardware.
...
| [XIAO nRF52840 & Wio-SX1262 Kit](./seeed-studio/wio-sx1262?wio-sx1262=nrf52840) | XIAO nRF52840 | Wio-SX1262 |      NO      | 5.0 | OPTIONAL |

### [Wio Tracker L1 Series](./seeed-studio/wio-tracker-l1)

A lightweight, portable node with flexible power and display options.

| Name                                            | MCU      | WiFi | BT  | GPS |
| :---------------------------------------------- | :------- | :--: | :-: | :-: |
| [Wio Tracker L1](./seeed-studio/wio-tracker-l1) | nRF52840 |  NO  | 5.0 | YES |
