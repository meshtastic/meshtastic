...
Meshtastic also supports using a Linux device as a 'node' through our platform, meshtasticd.
For full information, please see our [Linux](/docs/linux/) documentation.
