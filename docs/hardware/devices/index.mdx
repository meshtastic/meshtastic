...
### [Seeed Wio-WM1110](./seed-wm1110)

nRF52840-based development boards with GPS, and multiple ports to attach sensors.

| Name                                                       | MCU      | Radio  | WiFi | BT  | GPS |
| :--------------------------------------------------------- | :------- | :----- | :--: | :-: | :-: |
| [Seeed Wio-WM1110 Dev Kit](./seed-wm1110?wio-sdk-wm1110)   | nRF52840 | LR1110 | YES  | 5.3 | YES |
| [Seeed Wio Tracker 1110](./seed-wm1110?wio-tracker-wm1110) | nRF52840 | LR1110 | YES  | 5.3 | YES |
