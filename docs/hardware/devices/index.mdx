...
## [PSMG smart glasses by Seeed] (coming soon)

nRF52840-based development boards, and multiple ports to attach sensors via seeed grove connectors.


| Name                                                                      | MCU      | Radio  | WiFi | BT  | GPS      |
| :------------------------------------------------------------------------ | :------- | :----- | :--: | :-: | :-:      |
| [Seeed esp32-sx1262-kit](./seeed-studio/wm1110?wm1110=wio-sdk-wm1110)     | nRF52840 | LR1110 | YES  | 5.3 | OPTIONAL |

🕶️ PMSG: Dev-ready wearable with LoRa, WiFi, BT, (optional) OLED, motion sensors, vibration motor & LiPo power+ grove ports for more
