...
<DeviceSection device="rak4631.svg" size="md" />
...
| [RAK3312](./rak-wireless/wisblock/core-module?rakcore=RAK3312)   | ESP32-S3 | SX1262 | YES  | 5.0 | ADD-ON |
...
<DeviceSection device="rak4631_case.svg" size="md" />
...
| [WisMesh TAP](./rak-wireless/wismesh/tap/?tap=v1)                                         | nRF52840 | SX1262      |  NO  | 5.0 |  YES   |
| [WisMesh Tap V2](./rak-wireless/wismesh/tap/?tap=v2)                                      | ESP32-S3 | SX1262      | YES  | 5.0 |  YES   |
| [WisMesh Board ONE](./rak-wireless/wismesh/board-one.mdx)                                 | nRF52840 | SX1262      |  NO  | 5.0 | ADD-ON |
| [WisMesh 1W Booster](./rak-wireless/wismesh/1w-booster)                                   | nRF52840 | SX1262 (1W) |  NO  | 5.0 | ADD-ON |
...
| [WisMesh Wi-Fi MQTT Gateway](./rak-wireless/wismesh/gateway/?gateway=gateway-wifi)         | ESP32    | SX1262      | YES  | 5.0 | ADD-ON |

## LILYGO®

<DeviceSection device="tbeam.svg" size="md" />
### [T-Beam](./lilygo/tbeam/)
...
| [T-Beam 1W](./lilygo/tbeam/?t-beam=t-beam-1w)   | ESP32-S3 | SX1262 (1W) | 2.4GHz b/g/n | 5.0 | YES |

<DeviceSection device="t-echo.svg" size="md" />
...
| Name                                                | MCU      | Radio  | Wi-Fi | BT  | GPS |
| :-------------------------------------------------- | :------- | :----- | :--: | :-: | :-: |
| [T-Echo](./lilygo/techo/?techo=t-echo)              | nRF52840 | SX1262 |  NO  | 5.0 | YES |
| [T-Echo Plus](./lilygo/techo/?techo=t-echo-plus)    | nRF52840 | SX1262 |  NO  | 5.0 | YES |

<DeviceSection device="tlora-t3s3-v1.svg" size="md" />
...
<DeviceSection device="t-deck.svg" size="md" />
...
<DeviceSection device="lilygo-tlora-pager.svg" size="md" />

### [T-Lora Pager](./lilygo/tpager/)

Standalone device with screen and keyboard.

| Name                                                     | MCU      | Radio  | Wi-Fi | BT  | GPS |
| :------------------------------------------------------- | :------- | :----- | :--: | :-: | :-: |
| [T-Lora Pager](./lilygo/tpager/?tlora-pager=tlora-pager) | ESP32-S3 | LR1121 | YES  | 5.0 | YES |

<DeviceSection device="mini-epaper-s3.svg" size="md" />

### [Mini ePaper S3](./lilygo/mini-epaper/)

Compact e-ink node that takes an 18350 cell, supplied without a battery.

| Name                                          | MCU      | Radio  |     Wi-Fi     | BT  | GPS |
| :-------------------------------------------- | :------- | :----- | :----------: | :-: | :-: |
| [Mini ePaper S3](./lilygo/mini-epaper/)       | ESP32-S3 | SX1262 | 2.4GHz b/g/n | 5.0 | NO  |

<DeviceSection device="t5s3_epaper.svg" size="md" />

### [T5 E-Paper S3 Pro](./lilygo/t5-epaper/)

Large touch e-ink display with 16 grayscale levels. V2 adds a GNSS receiver.

| Name                                                        | MCU      | Radio  |     Wi-Fi     | BT  | GPS |
| :---------------------------------------------------------- | :------- | :----- | :----------: | :-: | :-: |
| [T5 E-Paper S3 Pro V2](./lilygo/t5-epaper/?t5-epaper=v2)    | ESP32-S3 | SX1262 | 2.4GHz b/g/n | 5.0 | YES |
| [T5 E-Paper S3 Pro V1](./lilygo/t5-epaper/?t5-epaper=v1)    | ESP32-S3 | SX1262 | 2.4GHz b/g/n | 5.0 | NO  |

<DeviceSection device="tlora-c6.svg" size="md" />
...
| Name                                | MCU       | Radio  |     Wi-Fi     |  BT   | GPS |
| :---------------------------------- | :-------- | :----- | :----------: | :---: | :-: |
| [T-LoRa C6](./lilygo/tlorac6/)      | ESP32-C6  | SX1262 | 2.4GHz b/g/n | 5.0\* | NO  |

\* The Meshtastic firmware does not support Bluetooth on ESP32-C6 modules.

<DeviceSection device="t-watch-s3.svg" size="md" />

### [T-Watch](./lilygo/twatch/)

Wearable node with a touch screen, haptics, speaker, and microphone.

| Name                                                          | MCU      | Radio  |     Wi-Fi     | BT  | GPS |
| :------------------------------------------------------------ | :------- | :----- | :----------: | :-: | :-: |
| [T-Watch S3 Plus](./lilygo/twatch/?twatch=t-watch-s3-plus)    | ESP32-S3 | SX1262 | 2.4GHz b/g/n | 5.0 | YES |
| [T-Watch S3](./lilygo/twatch/?twatch=t-watch-s3)              | ESP32-S3 | SX1262 | 2.4GHz b/g/n | 5.0 | NO  |

## HELTEC®

<DeviceSection device="heltec-v3.svg" size="xs" />
...
| Name                                                                                | MCU         | Radio  |     Wi-Fi     | BT  | GPS |
| :---------------------------------------------------------------------------------- | :---------- | :----- | :----------: | :-: | :-: |
| [LoRa32 V4](./heltec-automation/lora32/?heltec=v4)                                  | ESP32-S3R2  | SX1262 | 2.4GHz b/g/n | 5.0 | NO  |
| [LoRa32 V4-R8](./heltec-automation/lora32/?heltec=v4-r8)                            | ESP32-S3R8  | SX1262 | 2.4GHz b/g/n | 5.0 | NO  |
...
| [Wireless Tracker V2](./heltec-automation/lora32/?heltec=tracker-v2)                | ESP32-S3FN8 | SX1262 | 2.4GHz b/g/n | 5.0 | YES |
...
<DeviceSection device="heltec-vision-master-e213.svg" size="xs" />
...
<DeviceSection device="heltec-mesh-node-t114.svg" size="xs" />

### [Mesh Node](./heltec-automation/mesh-node)

| Name                                                            | MCU      | Radio  | Wi-Fi | BT  |   GPS    |
| --------------------------------------------------------------- | :------- | :----- | :--- | :-: | :------: |
| [Mesh Node T114](./heltec-automation/mesh-node/?heltec=mesh_node_t114) | nRF52840 | SX1262 | NO   | 5.0 | OPTIONAL |
| [Mesh Node T096](./heltec-automation/mesh-node/?heltec=t096) | nRF52840 | SX1262 | NO   | 5.0 | YES |
| [Mesh Node T1](./heltec-automation/mesh-node/?heltec=t1) | nRF52840 | SX1262 | NO   | 5.0 | YES |

<DeviceSection device="heltec_mesh_pocket.svg" size="md" />

### [MeshPocket](./heltec-automation/meshpocket/)

Compact device with QI2 wireless charging and integrated Meshtastic.

| Name                                                     | MCU      | Radio  | Wi-Fi | BT  | GPS |
| :------------------------------------------------------- | :------- | :----- | :--: | :-: | :-: |
| [MeshPocket](./heltec-automation/meshpocket/) | nRF52840 | SX1262 |  NO  | 5.0 | NO  |

<DeviceSection device="heltec-ht62-esp32c3-sx1262.svg" size="xs" />

### [HT-CT62](./heltec-automation/ht62/)

Tiny ESP32-C3 + SX1262 surface-mount module for DIY Meshtastic nodes.

| Name                                   | MCU      | Radio  |     Wi-Fi     | BT  | GPS |
| :------------------------------------- | :------- | :----- | :----------: | :-: | :-: |
| [HT-CT62](./heltec-automation/ht62/)   | ESP32-C3 | SX1262 | 2.4GHz b/g/n | 5.0 | NO  |

## Seeed Studio

<DeviceSection device="tracker-t1000-e.svg" size="md" />
...
| [MeshTracker X1](./seeed-studio/sensecap/meshtracker-x1/)     | nRF52840      | LR2021 | NO           | 5.0 | YES      |

<DeviceSection device="wio_tracker_l1_case.svg" size="md" />
...
| [XIAO ESP32-S3 & Wio-SX1262 Kit](./seeed-studio/wio-series/wio-sx1262s/?wio-sx1262=esp32-s3) | ESP32-S3 | Wio-SX1262 | 2.4GHz b/g/n | 5.0 | OPTIONAL |

## [B&Q Consulting](./b-and-q-consulting/)

<DeviceSection device="nano-g2-ultra.svg" size="md" />
...
| Name                                                       | MCU      | Radio  |     Wi-Fi     | BT  | GPS |
| :--------------------------------------------------------- | :------- | :----- | :--: | :-: | :-: |
| [Nano G2 Ultra](./b-and-q-consulting/nano/?nano-series=g2) | nRF52840 | SX1262 |  NO  | 5.0 | YES |

<DeviceSection device="station-g2.svg" size="md" />
...
<DeviceSection device="thinknode_m1.svg" size="md" />
...
| [ThinkNode M3](./elecrow/thinknode/?thinknode-series=m3) | nRF52840 | LR1110 |      NO      | 5.0 | YES |
| [ThinkNode M4](./elecrow/thinknode/?thinknode-series=m4) | nRF52840 | LR1110 |      NO      | 5.4 | YES |
| [ThinkNode M5](./elecrow/thinknode/?thinknode-series=m5) | ESP32-S3 | SX1262 | 2.4GHz b/g/n | 5.0 | YES |
| [ThinkNode M6](./elecrow/thinknode/?thinknode-series=m6) | nRF52840 | SX1262 |      NO      | 5.4 | YES |
| [ThinkNode M7](./elecrow/thinknode/?thinknode-series=m7) | ESP32-S3 | LR1110 | 2.4GHz b/g/n | 5.0 | NO  |
| [ThinkNode M9](./elecrow/thinknode/?thinknode-series=m9) | ESP32-S3 | LR1110 | 2.4GHz b/g/n | 5.0 | YES |

<DeviceSection device="crowpanel_5_0.svg" size="md" />
...
<DeviceSection device="meshstick.svg" size="md" />

### [MeshStick](./elecrow/meshstick/)

A USB LoRa radio rather than a node: it supplies the SX1262 transceiver, and a Linux host running [meshtasticd](/docs/meshtasticd/) supplies everything else. Up to 22 dBm over a CH341 USB-to-SPI bridge, with an SMA antenna connector.

## [muzi ᴡᴏʀᴋꜱ](./muziworks/)

<DeviceSection device="muzi_r1_neo.svg" size="md" />

### [R1 Neo](./muziworks/r1-neo/)

Compact and rugged device with built-in GPS, RTC, and buzzer.

| Name                          | MCU      | Radio  | Wi-Fi | BT  | GPS |
| :---------------------------- | :------- | :----- | :--: | :-: | :-: |
| [R1 Neo](./muziworks/r1-neo/) | nRF52840 | SX1262 |  NO  | 5.0 | YES |

<DeviceSection device="muzi_base.svg" size="md" />

### [BASE System](./muziworks/muzi-base/)

Modular development platform with custom core modules and expandable IO.

| Name                                                    | MCU      | Radio  | Wi-Fi | BT  | GPS |
| :------------------------------------------------------ | :------- | :----- | :--: | :-: | :-: |
| [Base Uno](./muziworks/muzi-base/?base-system=base-uno) | nRF52840 | SX1262 |  NO  | 5.0 |  NO |
| [Base Duo](./muziworks/muzi-base/?base-system=base-duo) | nRF52840 | LR1121 |  NO  | 5.0 |  NO |
...
| Name                                       | MCU      | Radio  |     Wi-Fi     | BT  | GPS |
| :----------------------------------------- | :------- | :----- | :----------: | :-: | :-: |
| [Unit C6L](./m5stack/unit-c6l/)            | ESP32-C6 | SX1262 | 2.4GHz b/g/n | 5.0 | NO  |
| [Cardputer Mesh Kit](./m5stack/cardputer/) | ESP32-S3 | SX1262 | 2.4GHz b/g/n | 5.0 | YES |
...
For full information, please see our [meshtasticd](/docs/meshtasticd/) documentation.
