...
To add a GPS to the RAK19003 or RAK19007 base boards, you should get the [RAK12500 GPS sensor](https://store.rakwireless.com/products/wisblock-gnss-location-module-rak12500). It is supported via I<sup>2</sup>C on slot B for RAK19003 and slot A on RAK19007 for firmware versions 1.49 and above.
