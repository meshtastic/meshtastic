...
If you wish to purchase parts separately, you will need a [WisBlock Base Board](../../../hardware/devices/rak/base-board) and a [WisBlock Core Module](../../../hardware/devices/rak/core-module). Please ensure you choose the correct operating frequency for your country when purchasing.
