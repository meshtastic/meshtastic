...
- **Program button (middle):**
  - **Long press:** Adjusts the brightness of the device's display (may not work for all display types). Holding down for 10 seconds will also shut down the device.
