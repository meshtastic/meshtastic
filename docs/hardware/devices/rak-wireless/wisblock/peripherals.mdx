...
- Purchase Links:
  ...
  - International
    - [RAKwireless RAK1910](https://store.rakwireless.com/products/rak1910-max-7q-gnss-location-sensor)
    - [RAKwireless RAK12500](https://store.rakwireless.com/products/wisblock-gnss-location-module-rak12500)
...
- Purchase Links:
  ...
  - International
    - [RAKwireless](https://store.rakwireless.com/collections/wisblock-interface/products/adapter-module-rak13002)
...
- Purchase Links:
  ...
  - International
    - [RAKwireless RAK1901](https://store.rakwireless.com/products/rak1901-shtc3-temperature-humidity-sensor)
    - [RAKwireless RAK1902](https://store.rakwireless.com/products/rak1902-kps22hb-barometric-pressure-sensor)
    - [RAKwireless RAK1906](https://store.rakwireless.com/products/rak1906-bme680-environment-sensor)
...
The [RAK12002 WisBlock RTC Module](https://store.rakwireless.com/products/rtc-module-rak12002) is a real-time-clock with a supercapacitor backup, allowing a node to maintain the correct time across reboots and for up to seven days without power. It operates on a crystal oscillator and communicates via the i2c interface. The module can be inserted into slots A, B or C (some users have reported issues with slot D) and is plug and play - no settings are required.
...
- Purchase Links:
  ...
  - International
    - [RAKwireless](https://store.rakwireless.com/products/rtc-module-rak12002)
