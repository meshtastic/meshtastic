...
When using the buzzer in Slot C of RAK19007 Base Board with the RAK4631(NRF Core Module), The configuration for the module is set as pin 21 in the Device section and set buzzer pin to 21 in the External Notifications module as well as use PWM.
### Resources
