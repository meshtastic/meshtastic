...
- [RAK19007](https://store.rakwireless.com/products/rak19007-wisblock-base-board-2nd-gen?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab) - WisBlock Base Board (2nd Generation, an upgrade to the RAK5005-O)
- **Slots**
  - (x1) Core Module slot
  - (x1) WisBlock IO Module slot
  - (x4) WisBlock Sensor Module slots
...
- Purchase Links:
  - US
    ...
    - [muzi ᴡᴏʀᴋꜱ Starter Kit](https://muzi.works/products/rak-wisblock-meshtastic-starter-kit-us915)
  - International
    - [RAKwireless](https://store.rakwireless.com/products/rak19007-wisblock-base-board-2nd-gen?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
    - [RAKwireless Starter Kit](https://store.rakwireless.com/products/wisblock-meshtastic-starter-kit?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
    - [RAKwireless AliExpress](https://www.aliexpress.com/item/3256803957557617.html?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
    - [RAKwireless AliExpress Starter Kit](https://www.aliexpress.com/item/1005006901039995.html?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
...
- [RAK19003](https://store.rakwireless.com/products/wisblock-base-board-rak19003?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab) - WisBlock's Mini Base Board.
- **Slots**
  - (x1) Core Module slot
...
- Purchase Links:
  ...
  - International
    - [RAKwireless](https://store.rakwireless.com/products/wisblock-base-board-rak19003?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
    - [RAKwireless AliExpress](https://www.aliexpress.com/item/3256803225234826.html?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
...
- Purchase Links:
  ...
  - International
    - [RAKwireless](https://store.rakwireless.com/products/rak19001-wisblock-dual-io-base-board?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
    - [RAKwireless AliExpress](https://www.aliexpress.com/item/3256803962043191.html?utm_source=website_partner&utm_medium=referral&utm_campaign=meshtastic_rak_collab)
