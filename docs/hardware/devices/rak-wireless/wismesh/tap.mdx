...
- Purchase Links:
  - US
    - [Rokland](https://store.rokland.com/products/wismesh-tap-v2-touchscreen-meshtastic-client-with-tft-screen-on-screen-keyboard-sx1262-lora-pid-116209)
  - International
    - [RAKwireless Store](https://store.rakwireless.com/products/meshtastic-touch-client-wismesh-tap-v2-sx1262)
