...
{label: 'Wi-Fi MQTT Gateway', value: 'gateway-wifi'}
]}>
...
- Purchase Links:
  - International
    - [RAKwireless Store](https://msh.to/wismesh-ethernet-gateway)
...
- **LoRa Transceiver:**
  - SX1262 ([RAK13300 LPWAN module](https://msh.to/rak13300))
...
- Further information on the WisMesh Wi-Fi MQTT Gateway can be found on the [RAK Documentation Center](https://docs.rakwireless.com/product-categories/meshtastic/wismesh-wifi-mqtt-gw/).
- Purchase Links:
  - International
    - [RAKwireless Store](https://msh.to/wismesh-wifi-gateway)
    - [RAKwireless AliExpress](https://msh.to/aliexpress-wismesh-wifi-gateway)

![RAK WisMesh Wi-Fi MQTT Gateway](/img/hardware/rak/wismesh-wifi-gateway.webp)
