...
![Heltec ESP32 V3 GPS module wiring diagram (through-hole, low-side switching)](/img/hardware/heltec/Heltec_ESP32V3_GPS_module_low-side.webp)
...
![Heltec ESP32 V3 SMD MOSFET wiring diagram](/img/hardware/heltec/Heltec_ESP32V3_SMDMosfetDiagram.webp)

![SMD MOSFET soldered in place on the Heltec ESP32 V3](/img/hardware/heltec/Heltec_ESP32V3_SMDMosfetInPlace.webp)

![SMD MOSFET and GPS module installed on the Heltec ESP32 V3](/img/hardware/heltec/Heltec_ESP32V3_SMDMOSFET_GPSInPlace.webp)
