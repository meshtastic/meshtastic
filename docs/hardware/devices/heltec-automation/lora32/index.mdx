...
<TabItem value="Wireless Bridge">

## Wireless Bridge

:::info
This device has a suboptimal ESP32/SX1276 chipset combination, but can be quite affordable for small, stationary setups.
:::
...
![Board View](</img/hardware/heltec/heltec-wireless-bridge-internal.webp>)
...
- **Connectors:**
  - Micro USB
  - Antenna:
    - LoRa Antenna interface (SMA)
    - 2.4G Antenna interface(SMA)
  - Battery (optional):
    - 3.7V Lithium interface (1.25x2)
- **Other:**
...
- Firmware file: `firmware-heltec-wireless-brdige-X.X.X.xxxxxxx.bin`
- From Heltec
  - [Product page](https://heltec.org/project/wireless-bridge/)
  - [Datasheet](https://resource.heltec.cn/download/Wireless_Bridge/bridge.pdf)
  - [Schematic Diagram (PDF)](https://resource.heltec.cn/download/Wireless_Bridge/Schematic_Diagram_HTIT-WB_V0.2.pdf)
  - [User Manual](https://docs.heltec.org/en/node/esp32/wireless_bridge/index.html)
