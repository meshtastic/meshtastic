...
![HTIT-WSL_V3_PIN_MAP](/img/hardware/HTIT-WSL_V3-Pin_Map.png)

Image Source: [Heltec](https://heltec.org/wp-content/uploads/2023/09/HTIT-WSL_V3.png)

![Hardware Resources](/img/hardware/Wireless-stick-lite-structure-chart.png)

Image Source: [Heltec](https://heltec.org/wp-content/uploads/2023/09/Wireless-stick-lite-structure-chart.png)

There are two antenna connectors. The one near the USB-C port (on the left when the text is readable) is for LoRa. The other is for WiFi
...
- From Heltec
  ...
  - [Schematic Diagram (PDF)](/documents/HTIT-WSL_V3_Schematic_Diagram.pdf)
  - [LoRa Node Development Kit (PDF)](/documents/HTIT-WSL_V3(Rev1.1).pdf)
