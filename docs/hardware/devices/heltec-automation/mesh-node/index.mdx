...
The firmware of  no-screen version is not the same as the screen version. The password for the no-screen version defaults to '123456'. If the device prompts you incorrectly, you may have downloaded the wrong version of the firmware. If you can't find the appropriate version, please contact support@heltec.cn.
