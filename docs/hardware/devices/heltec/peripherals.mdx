...
![Credit: https://adrelien.com/blog/how-to-add-telemetry-sensor-to-heltec-lora-v3-meshtastic-node/](/img/hardware/BMP280.png)
...
The hardware selection can be changed but we went with easy-to-get parts. **One thing to note here is that soldering will be needed only to solder headers to the Heltec and the BMP280 module**. This task can be outsourced to any nearby electronic shop and save you the money and the hassle.
...
![Credit: https://adrelien.com/blog/how-to-add-telemetry-sensor-to-heltec-lora-v3-meshtastic-node/](/img/hardware/How-To-Add-Telemetry-Sensor-To-Heltec-Lora-v3-Meshtastic-Node---v5.png)

BMP280-5V For The 5V Module

![Credit: https://adrelien.com/blog/how-to-add-telemetry-sensor-to-heltec-lora-v3-meshtastic-node/](/img/hardware/How-To-Add-Telemetry-Sensor-To-Heltec-Lora-v3-Meshtastic-Node---v3.png)
