...
<TabItem value="Telemetry">

## Telemetry

In this guide, we'll walk you through adding a telemetry sensor (BMP280)  module to your existing Heltec V3 Lora ESP32 Meshtastic Node. This guide will work also for any ESP32 boards but slight changes might be required.
...
:::info
The BMP280-5V Module Will Not Work With Battery, It Works Only With USB
:::
:::info
