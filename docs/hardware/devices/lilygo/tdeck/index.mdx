...
## Configuring GPS on T-Deck Plus
Referencing the [unit test code sample](https://github.com/Xinyuan-LilyGO/T-Deck/blob/master/examples/UnitTest/utilities.h) from LilyGo, you will need to set in Configuration -> Radio Config -> Position the GPIO pins for the GPS as follows:
Tx: 43
Rx: 44
...
- Purchase Links:
  ...
  - International
    - [LilyGO Store (T-Deck Dev Board)](https://lilygo.cc/products/t-deck-meshtastic)
    - [LilyGO Store (T-Deck Plus)](https://lilygo.cc/products/t-deck-plus-meshtastic)
