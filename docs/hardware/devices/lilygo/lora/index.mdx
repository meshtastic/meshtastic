...
{label: 'Lora T3S3 E-Paper', value:'S3-epaper'},
]}>
<TabItem value="v3.0">
...
<DeviceImage device="tlora-t3s3-v1.svg" alt="LILYGO LoRa T3S3" size="lg" center />
...
<TabItem value="S3-epaper">

## Lora T3S3 E-Paper

<DeviceImage device="tlora-t3s3-epaper.svg" alt="LILYGO LoRa T3S3 E-Paper" size="lg" center />

The E-Paper variant of the T3-S3 pairs an ESP32-S3 with a 2.13-inch E-Paper display and an SX1262 LoRa radio in a compact form factor.

- **MCU**
  - ESP32-S3FH4R2 (WiFi & Bluetooth 5 LE)
    - 4 MB flash
    - 2 MB PSRAM
- **LoRa Transceiver**
  - Semtech SX1262
...
- **Connectors**
  - USB-C
  - JST-GH connector for 3.7V Li-Po battery
  - microSD connector
...
- Built-in 2.13-inch E-Paper display (250 x 122).
- Compact 67 x 29 x 15 mm form factor.
- No GPS.

### Flashing the T3S3

To flash ESP32-S3 devices like the T3S3, you typically need to place them in Espressif's firmware download mode. Use the "1200bps reset" button in the web flasher to do this.

### Resources

- Firmware file: `firmware-tlora-t3s3-epaper-X.X.X.xxxxxxx.bin`
- Purchase Links:
  - US
    - [Rokland](https://store.rokland.com/products/lilygo-t3s3-e-paper)
  - International
    - [LilyGO Store](https://lilygo.cc/products/ts-s3-epaper)
