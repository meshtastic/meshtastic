...
Standalone device with screen and keyboard. T-Deck Plus also comes with a 2000 mAh battery. Both includes a secondary MCU that manages keyboard: ESP32-C3
