...
- Grant: [Pacific Northwest 3D LLC](https://pacificnorthwest3d.com)
  - Details: Pacific Northwest 3D LLC is a Meshtastic designer of devices, device enclosures and accessories that carry the "Meshtastic", Meshtastic.org URL and "M" logos. The use of the Meshtastic Logo and Trademarks does not imply Pacific Northwest 3D LLC is sponsored or endorsed by Meshtastic. Pacific Northwest 3D LLC also agrees to maintain compliance with the Meshtastic Legal requirements. This grant is revokable at any time for any reason.
