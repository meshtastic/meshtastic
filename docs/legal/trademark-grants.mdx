...
- Grant: [Ihor Bats - UkieLab](https://UkieLab.etsy.com/)
   - Details: Ihor is a GitHub sponsor and designer of iot devices including Meshtastic devices, device enclosures and accessories that carry the "Meshtastic", and runs an online shop for Meshtastic powered devices which carry the "Meshtastic" and "M" logos. The use of the Meshtastic Logo and Trademarks does not imply Neil is sponsored or endorsed by Meshtastic. Ihor also agrees to maintain compliance with the Meshtastic Legal requirements. This grant is revokable at any time for any reason.
