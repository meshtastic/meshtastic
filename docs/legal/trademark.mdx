...
- The adding our logo to a non-software good may be allowed, with written permission from the the Meshtastic Trademark Supervisior, provided that the non-software good is a 100% original design or the requester has evidence of a grant of use from copyright holder of the original design.
