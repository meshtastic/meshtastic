...
**May 2026** — [Architecture](architecture.md) — Documented KMP module layering, Navigation 3 patterns, and feature module conventions.

**May 2026** — [Contributing](contributing.md) — Established docs governance CI workflow for PRs that change UI without updating docs.
