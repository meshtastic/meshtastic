...
<picture>
  <source
    srcset="/img/android/android-waiting_dk.webp"
    media="(prefers-color-scheme: dark)"
  />
  <img
    src="/img/android/android-waiting_lt.webp"
    alt="Cloud with an up arrow"
  />
</picture>

![Cloud with an up arrow](/img/android/android-waiting_lt.webp#hideDark)![Cloud with an up arrow](/img/android/android-waiting_dk.webp#hideLight)
