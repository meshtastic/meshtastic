...
<picture>
  <source
    srcset="/img/android/android-waiting-dk.webp"
    media="(prefers-color-scheme: dark)"
  />
  <img
    src="/img/android/android-waiting-lt.webp"
    alt="Cloud with an up arrow"
  />
</picture>

![Cloud with an up arrow](/img/android/android-waiting-lt.webp#hideDark)![Cloud with an up arrow](/img/android/android-waiting-dk.webp#hideLight)

<ThemedImage
      alt="cloud up"
      className="max-h-8"
      sources={{
        light: useBaseUrl('/img/android/android-waiting-lt.webp'),
        dark: useBaseUrl('/img/android/android-waiting-dk.webp'),}}/>

Cloud with an up arrow: the message is queued in the app, waiting to be handed to the device.

![Cloud only](./img/android/android-sent-lt.webp.hideDark)![Cloud only](./img/android/android-sent-dk.webp.hideLight)

(/img/android/android-sent-lt.webp)

- Cloud only: the device received the message from the app, and it has been sent and transmitted via LoRa.
![Cloud with a check mark](/img/android/android-imp-ack_lt.webp#hideDark)![Cloud with a check mark](/img/android/android-imp-ack_dk.webp#hideLight)
- Cloud with a check mark: received at least one node's acknowledgement response. Confirmations could be from any one device.
![Person with a check mark](/img/android/android-DM-ack_lt.webp#hideDark)![Person with a check mark](/img/android/android-DM-ack_dk.webp#hideLight)
- Person with a check mark - The intended recipient node of your direct message acknowledged the message.
![Cloud crossed out](/img/android/android-no-ack_lt.webp#hideDark)![Cloud crossed out](/img/android/android-no-ack_dk.webp#hideLight)
