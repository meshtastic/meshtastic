...
You will need a device with Meshtastic installed to go any further. See the [getting started](../../getting-started) section for information on how to do this.
...
- See [Device Config](../../configuration/radio) for radio settings.
- See [Module Config](../../configuration/module) for module settings.
