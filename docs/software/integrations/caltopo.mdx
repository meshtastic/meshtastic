...
To configure our Meshtastic device for this integration, we have a couple of different options, both of which utilize the [Serial module](../../configuration/module/serial):
