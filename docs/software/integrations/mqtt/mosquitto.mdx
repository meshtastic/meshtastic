...
5. For Meshtastic to be able to access that server, two settings need to be changed in the
   `/etc/mosquitto/conf.d/mosquitto.conf` file:
...
Optionally pull a copy of [pdxlocations/MQTT-Connect-for-Meshtastic](https://github.com/pdxlocations/MQTT-Connect-for-Meshtastic)
