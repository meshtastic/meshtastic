...
The interactive simulator leverages the [Linux-native Meshtastic application](https://meshtastic.org/docs/software/linux/installation/), i.e., the real device software, while emulating some hardware components, including the LoRa chip. It can also run on Windows or macOS using Docker.
...
<div style={{ maxWidth: "800px", margin: "auto" }}>
  <ReactPlayer
    src="https://youtu.be/SwhO-WdwvrU"
    controls
    width="100%"
    height="400px"
  />
