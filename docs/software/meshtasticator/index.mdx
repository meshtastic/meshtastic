...
The interactive simulator leverages the [Linux-native Meshtastic application](/docs/linux/installation/), i.e., the real device software, while emulating some hardware components, including the LoRa chip. It can also run on Windows or macOS using Docker.
