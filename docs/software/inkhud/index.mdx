...
- **DIY Displays** ([custom builds](/docs/software/inkhud/diy-builds/), _for the brave.._)
...
For [DIY InkHUD devices](/docs/software/inkhud/diy-builds/), the firmware must be built manually.
