...
## Supported Devices
As of May 2025. Watch this space 👀
...
If you wish to use InkHUD with a DIY Meshtastic device, you will need to [build the firmware manually](/docs/development/firmware/build/), specially [configuring InkHUD for your hardware](https://github.com/meshtastic/firmware/blob/master/src/graphics/niche/InkHUD/docs/README.md#adding-a-variant).
