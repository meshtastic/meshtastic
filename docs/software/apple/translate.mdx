...
4. Follow the [steps for adding or updating translations](https://developer.apple.com/documentation/xcode/localizing-and-varying-text-with-a-string-catalog).
