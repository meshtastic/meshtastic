...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/standard_directConnected_dark.png" />
  <img src="/img/apple/standard_directConnected.png" alt="Directly connected node, favorite, with signal meter" />
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/standard_multiHop_dark.png" />
  <img src="/img/apple/standard_multiHop.png" alt="Multi-hop node 4 hops away" />
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/standard_mqtt_dark.png" />
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/compact_directConnected_allInfo_dark.png" />
  <img src="/img/apple/compact_directConnected_allInfo.png" alt="Directly connected node with all telemetry info" />
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/compact_multiHop_dark.png" />
  <img src="/img/apple/compact_multiHop.png" alt="Multi-hop node 7 hops away" />
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/compact_withPosition_dark.png" />
  <img src="/img/apple/compact_withPosition.png" alt="Node with position, 1 hop" />
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/compact_pkiMismatch_dark.png" />
  <img src="/img/apple/compact_pkiMismatch.png" alt="PKI key mismatch node" />
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="/img/apple/compact_mqtt_dark.png" />
