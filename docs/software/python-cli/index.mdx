...
The mesthastic command runs from your operating system shell prompt directly. If when you type "meshtastic" it doesn't find the command: Check that the python "scripts" directory is in your path.
