...
Configuration values are described in: [Configuration](../../configuration).
...
The destination node id for any sent commands.  Used for [Remote Node Administration](../../configuration/remote-admin)
