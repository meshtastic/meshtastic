...
| :----------: | :---------------: | :------------------------------------------------------------------------: |
| `IsLicensed` |      `true`       | See [User Config - IsLicensed](../../../configuration/radio/user#is-licensed-ham) |
|  `LongName`  |  _Your CallSign_  |     See [User Config - LongName](../../../configuration/radio/user#long-name)     |
| `ShortName`  |  _Abrv CallSign_  |    See [User Config - ShortName](../../../configuration/radio/user#short-name)    |
