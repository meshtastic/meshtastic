...
<Tabs groupId="operating-systems" queryString="os">
  <TabItem value="macos" label={<><Icon icon="mdi:apple" style={{ marginRight: "0.25rem" }} height="3rem" /></>} default>
    # MacOS
  ...
  <TabItem value="debian" label={<><Icon icon="mdi:debian" style={{ marginRight: "0.25rem" }} height="3rem" /></>} default>
    # Debian
  ...
  <TabItem value="raspbian" label={<><Icon icon="cib:raspberry-pi" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # Raspbian 32-bit
    ...
    For **64-bit** Raspberry Pi OS installations, please use the [<Icon icon="mdi:debian"/> Debian](/docs/meshtasticd/installation/?os=debian) packages.
    :::
  ...
  <TabItem value="ubuntu" label={<><Icon icon="mdi:ubuntu" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # Ubuntu
  ...
  <TabItem value="fedora" label={<><Icon icon="mdi:fedora" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # Fedora
  ...
  <TabItem value="epel" label={<><Icon icon="mdi:redhat" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # RedHat (EPEL)
  ...
  <TabItem value="docker" label={<><Icon icon="mdi:docker" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # Docker
  ...
  <TabItem value="flatpak" label={<><Icon icon="simple-icons:flatpak" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # Flatpak
  ...
  <TabItem value="openwrt" label={<><Icon icon="simple-icons:openwrt" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # OpenWrt
  ...
  <TabItem value="nixos" label={<><Icon icon="simple-icons:nixos" style={{ marginRight: "0.25rem" }} height="3rem" /></>}>
    # NixOS
