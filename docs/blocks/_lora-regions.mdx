...
|  `LORA_24`  |    Worldwide 2.4 GHz    |    2400.0 - 2483.5    |      100       |        10         |

:::info
The EU_433 and EU_868 region codes have to adhere to an hourly duty cycle limitation of 10%, calculated every minute on a rolling 1-hour basis. (6 minutes per hour) Your device will stop transmitting if you reach it, until it is allowed again.
:::
