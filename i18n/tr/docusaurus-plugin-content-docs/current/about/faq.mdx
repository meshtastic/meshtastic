...
slug: /sss
sidebar_position: 3
description: "Meshtastic ile ilgili sorularınıza cevaplar bulun: başlatmadan, cihaz kurulumu, gelişmiş özelliklere kadar. Uygulama uyumluluğu, kanal paylaşımı ve amatör telsiz lisansı avantajları hakkında bilgi edinin. Kapsamlı SSS (Sıkça Sorulan Sorular) bölümümüze göz atın."
---
...
## Python Komut Satırı Arayüzü (KSA)
...
Meshtastic, hem lisanssız kişiler hem de lisanslı amatör telsiz operatörleri tarafından kullanılabilir.
