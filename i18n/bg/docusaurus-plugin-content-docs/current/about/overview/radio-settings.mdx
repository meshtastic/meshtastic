---
id: radio-settings
title: Настройки на радиото
slug: /overview/radio-settings
sidebar_label: Настройки на радиото
sidebar_position: 1
...
:::info
Power limits will generally be lifted in the software if `is_licensed` is set to `true`. Вижте [Ham Mode](/docs/faq#amateur-radio-ham) за повече информация.
:::
...
Диапазонът на честотната лентата е от 433 до 434 MHz.
...
Диапазонът на честотната лента е от 869.40 до 869.65 MHz. This is less than the 863–870 MHz range defined as SRD ([Short Range Devices](https://www.etsi.org/technologies/short-range-devices)) Band, but allows for a higher ERP and a duty cycle of 10%.
...
Диапазонът на честотната лента е от 902 до 928 MHz
...
|     Radio Preset            | Alt Preset Name  | Data-Rate  | SF / Symbols | Coding Rate | Широчина на честотната лента   | Link Budget |
| :-------------------------: | :--------------: | :--------: | :----------: | :---------: | :----------------------------: | :---------: |
|    Short Range / Turbo      |  Short Turbo     | 21.88 kbps |  7 / 128     |   4/5       |           500 kHz[^1]          |   140dB     |
|     Къс обхват / Бърз       |   Short Fast     | 10.94 kbps |  7 / 128     |   4/5       |            250 kHz             |   143dB     |
|     Къс обхват / Бавен      |   Short Slow     | 6.25 kbps  |  8 / 256     |   4/5       |            250 kHz             |  145.5dB    |
|    Среден обхват / Бърз     |  Medium Fast     | 3.52 kbps  |  9 / 512     |   4/5       |            250 kHz             |   148dB     |
|   Среден обхват / Бавен     |  Medium Slow     | 1.95 kbps  |  10 / 1024   |   4/5       |            250 kHz             |  150.5dB    |
|    Дълъг обхват / Бърз      |   Long Fast      | 1.07 kbps  |  11 / 2048   |   4/5       |            250 kHz             |   153dB     |
|    Дълъг обхват / Умерен    |  Long Moderate   | 0.34 kbps  |  11 / 2048   |   4/8       |            125 kHz             |   156dB     |
| Дълго разстояние / Бавно    |   Long Slow      | 0.18 kbps  |  12 / 4096   |   4/8       |            125 kHz             |  158.5dB    |
...
| Data-rate  | SF / Symbols | Coding Rate | Широчина на честотната лента | Link Budget | Note                                                                     |
| :--------: | :----------: | :---------: | :--------------------------: | :---------: | :----------------------------------------------------------------------- |
