...
slug: /faq
sidebar_position: 3
description: "Намерете отговори на вашите въпроси относно Meshtastic: от започване, настройка на устройството до разширени функции. Научете за съвместимостта на приложенията, споделянето на канали и предимствата на лиценза за радиолюбители. Потопете се в нашите изчерпателни ЧЗВ."
---
...
## Любителско радио (радиолюбител)

Meshtastic може да се използва както от нелицензирани лица, така и от лицензирани радиолюбители.
