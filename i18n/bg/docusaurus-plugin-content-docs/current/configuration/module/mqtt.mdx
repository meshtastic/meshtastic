---
id: mqtt
title: Конфигурация на модула MQTT
sidebar_label: MQTT
...
Сървърът, който да се използва за MQTT. If not set, the default public server will be used.
...
Опциите за конфигурация на MQTT са достъпни за Android.

1. Отворете приложението Meshtastic
2. Отидете до: **Вертикално многоточие (3 точки горе вдясно) > Конфигурация на радиото > MQTT**
...
|     Настройка                | Допустими стойности | По подразбиране        |
| :--------------------------: | :-----------------: | :--------------------: |
...
## Свързване спубличния сървър по подразбиране
...
##### 3. Конфигуриране на мрежовите настройки
...
[![Мрежови настройки](/img/modules/mqtt/android_network_sm.webp)](/img/modules/mqtt/android_network.webp)
...
[![Мрежови настройки](/img/modules/mqtt/apple_network_sm.webp)](/img/modules/mqtt/apple_network.webp)
...
[![Мрежови настройки](/img/modules/mqtt/web_network_sm.webp)](/img/modules/mqtt/web_network.webp)
