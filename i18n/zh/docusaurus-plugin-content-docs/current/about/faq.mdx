...
slug: /faq
sidebar_position: 3
description: 關於 Meshtastic 疑難雜症的答案：從入門、裝置設定到進階功能，你都可以在這裡找到！ 了解應用程式相容性、頻道共享和 HAM 執照優勢。 Dive into our comprehensive FAQ.
---
...
Meshtastic 可同時供一般無執照使用者與持有業餘無線電（HAM/哈姆）的操作者使用。
