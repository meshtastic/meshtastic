---
id: installazione
title: Installazione Meshtastic Python CLI
sidebar_label: Installazione
slug: /software/python/cli/installation
sidebar_position: 1
description: Questa pagina offre istruzioni complete sui metodi di installazione del Meshtastic Python CLI su diversi sistemi operativi.
---
...
## Libreria Meshtastic Python

Questa libreria fornisce un'interfaccia a riga di comando (CLI) per gestire le impostazioni utente dei nodi Meshtastic e fornisce un'API facile per l'invio e la ricezione di messaggi attraverso radio mesh. Gli eventi vengono consegnati utilizzando un modello publish-subscribe e puoi iscriverti solo ai tipi di messaggio a cui sei interessato.
