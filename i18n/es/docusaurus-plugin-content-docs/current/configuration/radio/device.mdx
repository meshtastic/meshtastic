...
| Device Role    | Descripción                                                                                                                                                                                | Best Uses                                                                                                                                                   |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| CLIENT_MUTE    | El dispositivo no reenvía mensajes de otros dispositivos.                                                                                                                                  | Situations where a device needs to participate in the network without assisting in packet routing, reducing network load.                                   |
| CLIENT_HIDDEN  | Dispositivo que solo emite según sea necesario por sigilo o para ahorrar energía.                                                                                                          | Use in stealth/hidden deployments or to reduce airtime/power consumption while still participating in the network.                                          |
...
| TRACKER        | Transmisión de paquetes de posición GPS como prioridad.                                                                                                                                    | Tracking the location of individuals or assets, especially in scenarios where timely and efficient location updates are critical.                           |
| LOST_AND_FOUND | Transmite regularmente la ubicación como mensaje al canal predeterminado para asistir en la recuperación del dispositivo.                                                                  | Used for recovery efforts of a lost device.                                                                                                                 |
| SENSOR         | Transmite paquetes de telemetría como prioridad.                                                                                                                                           | Deploying in scenarios where gathering environmental or other sensor data is crucial, with efficient power usage and frequent updates.                      |
| TAK            | Optimizado para el sistema de comunicación ATAK, reduciendo las transmisiones rutinarias.                                                                                                  | Integration with ATAK systems (via the Meshtastic ATAK Plugin) for communication in tactical or coordinated operations.                                     |
| TAK_TRACKER    | Permite la transmisión automática TAK PLI y reduce las transmisiones rutinarias.                                                                                                           | Standalone PLI integration with ATAK systems for communication in tactical or coordinated operations.                                                       |
...
| -------------- | --------------- | -------------- | ----------------- | -------------- | ------------------- | --------------------- |
| CLIENT         | Yes             | Yes            | Regular           | Yes            | No                  | Sí                    |
| CLIENT_MUTE    | Sí              | Yes            | Lowest            | No             | No                  | Sí                    |
| CLIENT_HIDDEN  | Yes             | Yes            | Lowest            | Local Only     | No                  | No                    |
| CLIENT_BASE    | Yes             | Sí             | Regular           | Sí             | Favorites Only[^3]  | Yes                   |
| TRACKER        | Yes             | No             | Regular / Low     | Awake Only[^1] | No                  | Yes                   |
| LOST_AND_FOUND | Yes             | No             | Regular           | Sí             | No                  | Yes                   |
| SENSOR         | Yes             | No             | Regular / Low     | Awake Only[^1] | No                  | Yes                   |
| TAK            | Yes             | Optional       | Regular           | Yes            | No                  | Yes                   |
| TAK_TRACKER    | Sí              | Optional       | Regular           | Sí             | No                  | Yes                   |
| ROUTER         | No[^2]          | No             | High              | Yes            | Yes                 | Sí                    |
| ROUTER_LATE    | Yes             | Yes            | High              | Yes            | No                  | Sí                    |
| REPEATER       | Sí              | No             | High              | Sí             | Sí                  | No                    |
...
Deshabilita la triple pulsación del botón de usuario para activar o desactivar GPS.
...
| Setting                           | Acceptable Values                                                  | Por defecto           |
| --------------------------------- | ------------------------------------------------------------------ | --------------------- |
