...
title: Varastoi & välitä moduulin asetukset
sidebar_label: Varastoi & välitä
...
![Varastoi & välitä - yleiskatsaus](/img/modules/store_and_forward/store_and_forward-overview.webp)

### Vaatimukset

Varastoi ja välitä palvelimen vaatimukset:
