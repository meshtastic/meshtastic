---
id: vedä ja pudota
title: Vedä ja pudota nRF52 & RP2040 laiteohjelmistopäivitykset
sidebar_label: Vedä & Pudota (suositeltu)
sidebar_position: 1
...
## Asenna laiteohjelmisto

:::info
Voit nyt käyttää [Meshtastic Web Flasher](https://flasher.meshtastic.org) ladataksesi ja kopioidaksesi laiteohjelmiston nRF52 tai RP2040 -pohjaisille laitteillesi. Noudata vaihtoehtoisesti alla olevia ohjeita ladataksesi ja asentaaksesi laiteohjelman.
:::
