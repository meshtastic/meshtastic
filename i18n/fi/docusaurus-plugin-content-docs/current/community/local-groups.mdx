---
id: paikalliset-ryhmät
title: Paikalliset Ryhmät
sidebar_label: Paikalliset Ryhmät
slug: /yhteisö/paikalliset-ryhmät
sidebar_position: 1
---
...
Alla on lista ryhmistä, jotka ovat aktiivisesti organisoineet meshtastic verkostoja niiden alueilla. Voit ottaa yhteyttä
heihin saadaksesi apua aloittaessasi tai jos olet kiinnostunut osallistumaan verkostoon. If you're a group
...
- Ryhmät voivat käyttää Meshtastic logoa, jos se on toissijaisessa asemassa ryhmän ensisijaiseen brändiin. Epävarmoissa tapauksissa tulisi käyttää [M-Powered-logoa](/docs/legal/licensing-and-trademark/#community-project-logos-m-powered--m-pwrd) tai mukautettua logoa.
- Ryhmät eivät saa käyttää "Meshtastic [Kaupunki tähän]" niiden linkkinä, ryhmän nimenä tai sivuston otsikkona, koska tämä voi edellyttää virallista sponsorointia.
- Palvelimen kutsulinkkien on oltava niin, että ne eivät koskaan vanhene.
  :::
