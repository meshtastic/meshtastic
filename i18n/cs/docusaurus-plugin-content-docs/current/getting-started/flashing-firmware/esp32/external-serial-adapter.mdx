...
Připojte adaptér do počítače, aniž byste jej ještě připojili k jakémukoli zařízení. Ensure that your computer has drivers installed for the adapter. On Windows, the correct drivers should install automatically.
...
4. Připojte buď 5V pin adaptéru k 5V pinu zařízení (viz obrázek), nebo 3,3V pin adaptéru k 3,3V pinu zařízení.
