...
Čip ESP32 je starší a spotřebovává více energie než čip nRF52, ale je vybaven jak WiFi, tak Bluetooth. Mezi podporovaná zařízení ESP32 patří:

- LILYGO® TTGO T-Beam (>V1.1 recommended)
- LILYGO®️ TTGO Lora (doporučeno >V2.1)
- Nano G1
- Station G1
