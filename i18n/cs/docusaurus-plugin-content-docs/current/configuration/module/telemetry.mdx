...
|   Senzor     | I<sup>2</sup>C Address |                Data Points                                             |
| :----------: | :--------------------: | :--------------------------------------------------------------------: |
| AHT10, AHT20 |      0x38              |                Teplota a vlhkost                                       |
|   BMP085     |    0x76, 0x77          |              Teplota a barometrický tlak                               |
|   BMP180     |    0x76, 0x77          |              Teplota a barometrický tlak                               |
|   BMP280     |    0x76, 0x77          |              Teplota a barometrický tlak                               |
|   BME280     |    0x76, 0x77          |            Teplota, barometrický tlak a vlhkost                        |
|   BMP388     |    0x76, 0x77          |          Barometric pressure, Temperature                              |
|   BMP390     |    0x76, 0x77          |          Barometric pressure, Temperature                              |
|   BME68x     |    0x76, 0x77          |        Teplota, barometrický tlak, vlhkost a odpor vzduchu             |
|   DPS310     |    0x76, 0x77          |          Barometric pressure, Temperature                              |
|  MCP9808     |      0x18              |                  Teplota                                               |
|   INA219     |   0x40, 0x41, 0x43     |                Proud a napětí                                          |
|   INA226     |   0x40, 0x41, 0x43     |                Proud a napětí                                          |
|   INA260     |   0x40, 0x41, 0x43     |                Proud a napětí                                          |
|  INA3221     |      0x42              |           3-channel Current and Voltage                                |
|   LPS22      |    0x5D, 0x5C          |               Barometrický tlak                                        |
|   SHTC3      |      0x70              |                Teplota a vlhkost                                       |
|   SHT31      |    0x44, 0x45          |                Teplota a vlhkost                                       |
|   SHT4X      |    0x44, 0x45          |                Teplota a vlhkost                                       |
...
Výchozí hodnota je `1800` sekund (30 minut).
...
### RAK 4631 se senzorem prostředí BME680

Nastavení RAK 4631 se senzorem prostředí
