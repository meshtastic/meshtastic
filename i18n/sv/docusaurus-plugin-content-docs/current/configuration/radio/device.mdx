...
| Device Role    | Beskrivning                                                                                                                                                                                       | Best Uses                                                                                                                                                   |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| CLIENT_MUTE    | Nod som inte vidarebefordrar meddelanden.                                                                                                                                                         | Situations where a device needs to participate in the network without assisting in packet routing, reducing network load.                                   |
| CLIENT_HIDDEN  | Nod som endast kommunicerar vid behov för att gömma sig och samtidigt hålla nere strömförbrukningen.                                                                                              | Use in stealth/hidden deployments or to reduce airtime/power consumption while still participating in the network.                                          |
...
| TRACKER        | Nod som prioriterar GPS meddelanden.                                                                                                                                                              | Tracking the location of individuals or assets, especially in scenarios where timely and efficient location updates are critical.                           |
| LOST_AND_FOUND | Skickar regelbundet ut GPS position på standardkanalen för att assistera vid uppsökande.                                                                                                          | Used for recovery efforts of a lost device.                                                                                                                 |
| SENSOR         | Nod som prioriterar telemetri meddelanden.                                                                                                                                                        | Deploying in scenarios where gathering environmental or other sensor data is crucial, with efficient power usage and frequent updates.                      |
| TAK            | Roll optimerad för användning tillsammans med ATAK.                                                                                                                                               | Integration with ATAK systems (via the Meshtastic ATAK Plugin) for communication in tactical or coordinated operations.                                     |
| TAK_TRACKER    | Skickar automatiskt ut GPS position för användning med ATAK.                                                                                                                                      | Standalone PLI integration with ATAK systems for communication in tactical or coordinated operations.                                                       |
...
| -------------- | --------------- | -------------- | ----------------- | -------------- | ------------------- | --------------------- |
| CLIENT         | Yes             | Yes            | Regular           | Yes            | No                  | Ja                    |
| CLIENT_MUTE    | Ja              | Yes            | Lowest            | No             | No                  | Ja                    |
| CLIENT_HIDDEN  | Yes             | Yes            | Lowest            | Local Only     | No                  | No                    |
| CLIENT_BASE    | Yes             | Ja             | Regular           | Ja             | Favorites Only[^3]  | Yes                   |
| TRACKER        | Yes             | No             | Regular / Low     | Awake Only[^1] | No                  | Yes                   |
| LOST_AND_FOUND | Yes             | No             | Regular           | Ja             | No                  | Yes                   |
| SENSOR         | Yes             | No             | Regular / Low     | Awake Only[^1] | No                  | Yes                   |
| TAK            | Yes             | Optional       | Regular           | Yes            | No                  | Yes                   |
| TAK_TRACKER    | Ja              | Optional       | Regular           | Ja             | No                  | Yes                   |
| ROUTER         | No[^2]          | No             | High              | Yes            | Yes                 | Ja                    |
| ROUTER_LATE    | Yes             | Yes            | High              | Yes            | No                  | Ja                    |
| REPEATER       | Ja              | No             | High              | Ja             | Ja                  | No                    |
