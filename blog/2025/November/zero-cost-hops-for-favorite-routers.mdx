...
![Blursed image of a hopscotch game with multiple 3s and 4s written on the squares](/img/blog/zero_cost_hopscotch.png)
...
- Helps avoid `CLIENT_BASE` from being the last hop of a packet, avoiding messages dying on the roof before reaching your indoor nodes.
...
- Each hilltop `ROUTER` favorites each other.
