...
The **default** preset, LongFast, uses 125 kHz bandwidth with a spreading factor of 11. This configuration provides excellent range out of the box but comes at the cost of relatively slow data transmission (about 1 kbps).
