...
The **default** preset, LongFast, uses 125 kHz bandwidth with a spreading factor of 11. This configuration provides excellent range but comes at the cost of relatively slow data transmission (about 1 kbps).
...
- **Meshtastic Bay Area Group**: A community mesh in the San Francisco Bay Area switched to MediumSlow and reported...
