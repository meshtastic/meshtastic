...
The combination of these factors leads to lower effective throughput across your entire mesh, even though LongFast seems like it should deliver messages reliably.

## Benefits of Higher Bandwidth Presets

Switching to higher bandwidth presets like MediumFast, ShortSlow, or even ShortFast offers several advantages:
...
In dense networks, the improved throughput often more than compensates for the slightly reduced range, resulting in better overall message delivery.
...
- **More than 60 nodes** in relatively close proximity
- **High message volume** from many users or automated systems
- **Dense Urban / suburban deployment** where maximum range is less important than throughput
...
Many larger Meshtastic deployments have seen substantial improvements after switching from LongFast:
