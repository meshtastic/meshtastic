  ...
  return (
    ...
    >
      <div className="container mt-8 flex flex-col gap-3">
        <h1 className="m-2"><Translate id="downloads.flasher.heading">Flasher</Translate></h1>
          ...
          <div className="flex w-full flex-col bg-primary xl:flex-row">
            <div className="card m-4 border-2 border-secondary">
              <div className="card__header">
                <h3><Translate id="downloads.flasher.webFlasher">Web Flasher</Translate></h3>
              </div>
              ...
              <div className="card__footer mt-auto">
                ...
                >
                  <Translate id="downloads.flasher.goToWebFlasher">Go to Web Flasher</Translate>
            ...
            <div className="card m-4 border-2 border-secondary w-full">
              ...
              <div className="card__footer mt-auto">
                <a
                  ...
                  className="m-auto flex rounded-lg border-4 border-transparent bg-accent p-1 font-semibold text-black shadow-md hover:text-black hover:brightness-110 active:border-green-200"
                >
                  <Translate id="downloads.flasher.goToFlasher">Go to Flasher</Translate>
                  <ArrowTopRightOnSquareIcon className="m-auto ml-2 h-4" />
                </a>
              </div>
            </div>
        ...
        {/*  */}
        <h1 className="m-2"><Translate id="downloads.apps.heading">Apps</Translate></h1>
        <div className="flex w-full overflow-hidden rounded-xl">
          ...
          <div className="flex w-full columns-3 flex-col bg-primary lg:flex-row">
            <div className="card m-4 border-2 border-secondary">
              <div className="card__header">
                <h3><Translate id="downloads.apps.apple">Apple</Translate></h3>
              </div>
            ...
            <div className="card m-4 border-2 border-secondary">
              <div className="card__header">
                <h3><Translate id="downloads.apps.android">Android</Translate></h3>
              </div>
              <div className="card__body flex items-center">
                <div className="m-auto">
              ...
              <div className="card__body">
                <Translate id="downloads.apps.androidSideloading">Sideloading also available.</Translate>
              </div>
              <div className="card__footer mt-auto">
                <a
                  target="_blank"
                ...
                >
                  <Translate id="downloads.apps.playStore">Play Store</Translate>
                  <ArrowTopRightOnSquareIcon className="m-auto ml-2 h-4" />
                </a>
              </div>
            </div>
            <div className="card m-4 border-2 border-secondary">
              <div className="card__header">
                <h3><Translate id="downloads.apps.web">Web</Translate></h3>
              </div>
              <div className="card__body flex items-center">
                <div className="m-auto">
              ...
              <div className="card__body">
                <Translate id="downloads.apps.webDescription">Requires Chromium based browsers.</Translate>
              </div>
              <div className="card__footer mt-auto">
                <a
                  target="_blank"
        ...
        {/*  */}
        <h1 className="m-2"><Translate id="downloads.firmware.heading">Firmware</Translate></h1>
        <div className="flex w-full overflow-hidden rounded-xl">
              ...
              <>
                <FirmwareCard
                  ...
                  description={translate({
                    ...
                    message: "Tested feature set. For those who want stability.",
                  })}
                ...
                <div className="card m-4 border-2 border-secondary">
                  <div className="card__header">
                    <h3><Translate id="downloads.firmware.bleeding">Bleeding</Translate></h3>
                  </div>
                  <div className="card__body">
                    <p>
                  ...
                  <div className="card__footer mt-auto">
                    ...
                    >
                      <Translate id="downloads.firmware.downloadBleeding">Download Bleeding</Translate>
                    </a>
                  </div>
                </div>
              </>
